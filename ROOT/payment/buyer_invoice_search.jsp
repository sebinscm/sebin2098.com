...
function fnView(inv_no, sup_id,buyer_id) {
  ...
  document.frmMain.action = './buyer_invoice_details.jsp';
...
<FORM NAME=frmMain action="buyer_invoice_search.jsp" METHOD=POST >
...
<TD width=3%><FONT size=2>Suppler ID </FONT></TD>
<TD width=15%><FONT size=2>Suppler Name </FONT></TD>
<TD width=15%><FONT size=2>Invoice Number </FONT></TD>
<TD width=15%><FONT size=2>Invoice File </FONT></TD>
<TD width=3%><FONT size=2>Updated  </FONT></TD>
<TD width=5%><FONT size=2>Invoiced</FONT></TD>
<TD width=10%><FONT size=2>Invoice Date </FONT></TD>
</tr>
<%=outS%>
</FORM>
