...
function fnView(inv_no, sup_id,buyer_id) {
  ...
  frmMain.action = './buyer_payment_details.jsp';
  frmMain.submit();
}
function fnPOView(po_no_selected) {
  frmMain.po_no_selected.value = po_no_selected;
  frmMain.action = "/ordermanagement/buyer_po_details.jsp";
  frmMain.submit();
}
...
<FORM name='frmMain' ACTION="buyer_payment_search.jsp" METHOD=POST>
...
<tr>
  ...
  <td width="10%" class="table_header_center">Invoice#</td>
...
<tr>
  ...
  <td class="table_bg_bright" colspan="3"><select name='ag_date_type'>
...
<input type='hidden' name='ag_buyer' value='<%= scmid %>'>
