...
function fnList(frm) {
  ...
  frm.action = './admin_payment_search.jsp';
  frm.submit();
}
...
<tr>
  ...
  <td width="*" class="left_title"> Payment Detail</td>
</tr>
<tr>
...
<TR>
  <TD width='150' class='table_header_center'>Invoice#</TD>
...
<TR>
  <TD class='table_header_center'>Saved Invoice File</TD>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>[ Buyer Payment Status ]</b> <font color=red> <%= closed_msg%></font><br>
