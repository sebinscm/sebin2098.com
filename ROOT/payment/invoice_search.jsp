...
function fnView(inv_no, sup_id,buyer_id,chk_status) {
  document.frmMain.inv_no.value = inv_no;
  document.frmMain.sup_id.value = sup_id;
  document.frmMain.buyer_id.value = buyer_id;
   document.frmMain.chk_status.value = chk_status;
  document.frmMain.action = './invoice_edit_form.jsp';
...
<FORM NAME=frmMain action="invoice_search.jsp" METHOD=POST >
