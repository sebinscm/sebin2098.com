...
{
  if (!frm.attached_file1.value && !frm.attached_file2.value && !frm.attached_file3.value ) {
    alert('Select the file first to edit.');
    return;
  }

   
  if (confirm('Do you want to replace with new file?')) {
    frm.action = './sample_sheet_update.jsp';
    frm.submit();
  }
}
...
<TR>
  ...
  <TD width='150' class='table_bg_bright'><%= modified %></TD>
   <TD width='200' class='table_header_center'> Sent date </TD>
...
<TR>
  ...
  <TD width='150' class='table_bg_bright'><%= created %></TD>
   <TD width='200' class='table_header_center'>Updated ID</TD>
...
<TR>
  ...
  <TD  width='100' class='table_bg_bright' colspan=3><input type='file' name='attached_file1' size='60' maxlength='200'></TD>
 </TR>
 <TR>
  ...
  <TD   width='100' class='table_bg_bright' colspan=3><input type='file' name='attached_file2' size='60' maxlength='200'></TD>
  </TR>
  <TR>
  ...
  <TD  width='100' class='table_bg_bright' colspan=3><input type='file' name='attached_file3' size='60' maxlength='200'></TD>
</TR>
  <TR>
...
<tr>
  ...
  ** Click 'Edit File' if you want to edit sheet file.
...
<tr>
  <td width="100%">
    <input type='button' value=' Edit File ' onclick='fnUpdate(document.frmMain);'>
