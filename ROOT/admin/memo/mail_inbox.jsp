...
String sql = "SELECT seqno, sender_name,title," +
		...
		" FROM mail_02t " +
		" WHERE userid = '" + userid +
		"' AND ( read_flag = '1' OR read_flag is null ) AND del_flag is null " +
		" ORDER BY seqno ASC ";
...
function ToMybox(form)
{
    if( check_select(form) )
    {
        form.action = "inbox_tomybox.jsp";
        form.submit();
    } else {
        alert("Click the checkbox next to the messages you want to move to mybox");
    }
}
...
<BR>
&nbsp;
<a href="javascript:ToMybox(document.frmMain)"><IMG SRC="img/mail_tomybox.gif" border=0 onmouseover="this.src='img/mail_tomybox_over.gif'" onmouseout="this.src='img/mail_tomybox.gif'" ></a><a href="javascript:Delete(document.frmMain)"><IMG SRC="img/inbox_delete.jpg" border=0 onmouseover="this.src='img/inbox_delete_over.jpg'" onmouseout="this.src='img/inbox_delete.jpg'" ></a><a href="javascript:reset()"><IMG SRC="img/inbox_reset.jpg" border=0 onmouseover="this.src='img/inbox_reset_over.jpg'" onmouseout="this.src='img/inbox_reset.jpg'" ></a>
</FORM>
</BODY>
</HTML>
