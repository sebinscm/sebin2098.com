...
try {
    ...
    sql = "select order_no, brand, delivery_date, confirm_date, style, sizc_1, sizc_2, sizc_3, sizc_4, sizc_5, sizc_6, total_qty, inhouse_date  from purchase_order where order_no='"+ po_num +"';";
    iRet = dataProcess.RetrieveData(sql, matrix, conn);
