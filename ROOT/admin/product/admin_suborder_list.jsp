...
<tr>
  ...
  <td width="*" class="left_title">Contractor Order Management</td>
</tr>
<tr>
...
* To create or update Contractor Order, Select the PO from the list below first.
