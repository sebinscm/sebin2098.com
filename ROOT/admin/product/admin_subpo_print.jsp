...
// Select PO master  
  sql = "  Select ORDER_NO ,  STYLE , SEASON ,  SGR ,  PGR  , "
	      + "   FABRIC, ITEM_TEXT, SUP_STOCK_CODE, format(local_price,2) , date_format(INITIAL_DEL_DATE, '%Y/%m/%d'), "
...
//out.println(sql);	      
 ...
 sql = "  select  a.id, a.name,a.phone1,a.fax, concat(a.addr1,' ',a.addr2) as addr , " +
          ...
          " where   a.user_type = 'P'  and a.id='"+subsupplier+"' " ;
...
<%
 if ( Integer.parseInt(order_status) < 45 ) {
%>
<table width='100%' border='0' cellspacing='0' cellpadding='2'>
<tr valign='top'>
  <td width='54%'><span class='font_title'><%= page_title %></span>
    ...
    <span class='font_small_1_bold'><br>Manufacturer: <%= bname %></span></td>
...
<tr>
  <td width='100%' class='font_small_2'>**Note)
    <ul>
      <li>This is Pre-Purchase Order only, NOT OFFICIAL PO until it is confirmed. 
      <li>This Pre-Purchase Order means, its status is Pro forma Purchase Order. 
      <li>THE OFFICIAL PO IS ONLY AFTER CONFIRMED!! </li>
    </ul>
  </td>
</tr>
</table>
...
<tr valign='top'>
  ...
  <td width='46%'><span class='font_subtitle'><%= sname %></span>
    <span class='font_small_1'><br><%= supplier_addr1 %>,<%= supplier_addr2 %>
...
<table width='650' border='0' bordercolor='black' cellspacing='0' cellpadding='0'>
<tr><td>
<table width='100%' border='1' cellspacing='1' cellpadding='2' align='center' bordercolor='black' >
  <tr class='table_header'>
    ...
    <td width="23%" height="16" >Vender</td>
  ...
  <tr class='table_header'>
    ...
    <td width="21%" height="22" >Material </td>  
  ...
  <tr class='table_header'>
    <td width="19%" height="22" >Local Price</td>
    <td width="16%" height="22" >Task#</td>
    <td width="19%" height="22" >Re-order SEQ</td>
    <td width="16%" height="22" >Amend Date</td>
    <td width="16%" height="22" >&nbsp;</td>
  </tr>
  <tr class='table_list_center'>
    <td width="23%" height="23" ><%=unitprice%> &nbsp;&nbsp;(RMB)</td>
...
<table width='650' border='1' cellspacing='1' cellpadding='2' align='center' bordercolor='black'>
  <tr class='table_header'>
