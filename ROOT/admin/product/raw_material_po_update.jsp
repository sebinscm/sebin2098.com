...
<%
    ...
    try{
        ...
        sql = " UPDATE raw_material_purchase_order SET "         
            + " po_num = ?, date_ordered = ?, writer = ?, factory = ?, out_shell_length = ?, combination_length = ?, lining_length = ?, "
                + "inter_lining_length = ?, button_length = ?, hanger_tape_length = ?, sewing_yarn_length = ?, "
        ...
        sql = "delete from raw_material_fabric where po_num='" + po_num + "'";
        pstmt = conn.prepareStatement(sql);
        pstmt.executeUpdate();
