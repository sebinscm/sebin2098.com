...
<%
    ...
    try{
        ...
        sql = " UPDATE cost_sheet SET "
          ...
          + "domestic = ?, international = ?, etc = ?, benefit = ?, dollor = ?, currency = ? where po_num ='"+po_num+"';";
        ...
        sql = "delete from cost_sheet_purchase_in_stock where po_num='" + po_num + "'";
        pstmt = conn.prepareStatement(sql);
        pstmt.executeUpdate();
