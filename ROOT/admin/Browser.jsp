...
<link rel="stylesheet" type="text/css" href="<%=CSS_NAME%>">
	...
	<style type="text/css">
		...
		table.filelist {background-color:#666666; width:50%; border:0px none #ffffff}
...
<b>Upload of <%=fname%></b><br><br>
<center>
<table height="20px" width="50%" bgcolor="#eeeeee" style="border:1px solid #cccccc"><tr>
...
<tr>
  ...
  <td width='*' class='left_title'>Stye image search</td>
</tr>
<tr>
...
<tr>
  <td height='10' colspan='2'></td>
    ...
    Style image filename filter: <input name="filt" onKeypress="event.cancelBubble=true;" onkeyup="filter(this)" type="text">
    <br /><br />
	<!--table  id="filetable" class="filelist" cellspacing="1px" cellpadding="0px"-->
	<table  id="filetable" class="filelist" width=800 cellspacing="1px" cellpadding="0px">	
<%
	...
	<p align=center>
		...
		<% if (!READ_ONLY) {%>
			...
			onclick="return confirm('Do you really want to delete the image(s)?')">
		<% } %>
	<% if (!READ_ONLY) {%>
	<br />
