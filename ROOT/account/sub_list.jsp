...
function fnSave(frm) {
  if (!jf_ChkValue(frm.suppId.value)) {
    alert('Please input new button first to create new supplier!');
    frm.suppId.select();
    return;
  }	
...
<tr>
  ...
  <td width='*' class='left_title'>Manufacturer Management</td>
</tr>
<tr>
...
* Registered ID cannot be changed. If you want to change ID, delete and create again. <br>
  Click 'New" to create new manufacturer. ID will be named automatically.
<tr>
  <td width='20%' class='table_header_center'>ID(*)</td>
  <td width='30%' class='table_bg_bright'><input type='text' name='suppId' size='5' maxlength='5'></td>
  <td width='20%' class='table_header_center'>Name</td>
