...
function fnSubmit(frm)
{
  ...
  frm.action = "./buyer_order_edit_list.jsp"
...
function fnView(po_no_selected) {
  ...
  frmMain.action = "./buyer_po_edit.jsp";
  frmMain.submit();
}
...
function fnExcel(frm) {
  ...
  {
    frm.action="./buyer_po_list_excel.jsp";
    //frm.target = hidenFrame.name;
    frm.submit();
  }
}
...
<tr>
  ...
  <td width="*" class="left_title">BUYER : Edit Purchase Order</td>
</tr>
<tr>
...
Step 1. Search the PO first from the query dialog box below. <br>
Step 2. Then the PO search result will be listed below.<br>
Step 3. Select the PO from the search result for editing.
