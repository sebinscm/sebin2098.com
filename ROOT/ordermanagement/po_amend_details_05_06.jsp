...
String fromUrl = "po_amend_details.jsp";
...
function fnSave(frm) { 
  ...
  if (confirm('Do you really want to save these data?')) { 
    frm.action = './order_amend_update.jsp';
    frm.submit();
  }
}
...
function fnList(frm)
{ 
  frm.action = "./order_amend_list.jsp";  
  frm.submit(); 
}
...
<tr>
  ...
  <td width='*' class='left_title'>Purchase Order Amendment</td>
</tr>
<tr>
...
<tr><td>
<font color=red>Note: (*) marked item cannot be edited. PO status: <%=order_status%></font>
...
<form name="form1" method="post">
  ...
  <tr class="table_header_center">
    ...
    <td width="19%" height="22" class='table_header_center2'>하Manufacturer</td>
    <td width="16%" height="22" class='table_header_center2'>Task#</td>
  </tr>
  <tr class="table_header_center">
  ...
  <tr class="table_header_center">
    <td width="21%" height="22" class='table_header_center2'>BRAND</td>
    <td width="21%" height="22" class='table_header_center2'>Shipping Type</td>
    <td width="23%" height="22" class='table_header_center2'>Local Price</td>
    <td width="19%" height="22" class='table_header_center2'>Re-order SEQ</td>
    <td width="16%" height="22" class='table_header_center2'>Amend Date</td>
  </tr>
  <tr class="table_header_center">
