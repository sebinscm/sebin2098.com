...
function fnView(po_no_selected) {
  frmMain.po_no_selected.value = po_no_selected;
  frmMain.action = "./buyer_po_details_screen.jsp";
  frmMain.submit();
}
...
function fnSave(frm) {
  ...
  if (confirm('Do you want to update the PO( '+frm.po_no.value+' ) Status?')) {      	
        frm.action = './buyer_order_status_save.jsp';
...
<tr>
  ...
  <td width="*" class="left_title">Buyer Order Status </td>
</tr>
<tr>
...
<tr>
  ...
  <td class="table_header_center">Buyer ID</td>
  <td class="table_bg_bright"><%= scmid %></td>
</tr>
<tr>
