...
<html>
<head>
<title>Purchase Order Amendment</title>
...
function fnSave(frm) { 
  ...
  if (confirm('Do you really want to save these data?')) { 
    frm.action = './buyer_order_amend_update.jsp';
    frm.submit();
  }
}
...
function fnList(frm)
{ 
  frm.action = "./buyer_order_amend_input.jsp";  
  frm.submit(); 
}
...
<tr>
  ...
  <td width='*' class='left_title'>Buyer Purchase Order Amendment</td>
</tr>
<tr>
...
<tr><td>
<font color=red>Note: (*) marked item cannot be edited. PO status( <%=order_status%>:<%=status_name %>	)</font>
...
<form name="form1" method="post">
  ...
  <tr class="table_header_center">
    <td width="21%" height="16" bgcolor=#ABAEB0><font color=white>*PO#</font></td>
    <td width="21%" height="16" class='table_header_center2'><font color=white>Style#</font></td>
    <td width="23%" height="16" bgcolor=#ABAEB0><font color=white>*Buyer</font></td>
    <td width="35%" colspan="2" height="16" bgcolor=#ABAEB0><font color=white>*Supplier</font></td>
  </tr>
  <tr class="table_header_center">
    ...
    <td width="23%" height="23" class='table_bg_bright'><select name="buyer"  disabled><%= outS01 %></select></td>
    <td width="35%" colspan="2" height="23" class='table_bg_bright'><select name="supplier" disabled ><%=outS02 %></select></td>
  </tr>
  <tr class="table_header_center">
    <td width="21%" height="16" class='table_header_center2'>Product Group</td>
    <td width="21%" height="16" class='table_header_center2'>Sub group</td>
    <td width="23%" height="16" class='table_header_center2'>Unit Price</td>
    <td width="19%" height="16" class='table_header_center2'>Order date</td>
    <td width="16%" height="16" class='table_header_center2'>Delivery Date</td>
  </tr>
  <tr class="table_header_center">
  ...
  <tr class="table_header_center">
    <td width="21%" height="22" class='table_header_center2'>Ship type</td>
    <td width="21%" height="22" class='table_header_center2'>Material</td>
    <td width="23%" height="22" class='table_header_center2'>Season</td>
    <td width="19%" height="22" class='table_header_center2'>BRAND</td>
    <td width="16%" height="22" class='table_header_center2'>Ship Type</td>
  </tr>
  <tr class="table_header_center">
    ...
    <td width="19%" height="27" class='table_bg_bright'><input type='text' value='<%= brand %>' name='brand' size='20' maxlength='20' class='input_text'></td>
    <td width="16%" height="27" class='table_bg_bright'><SELECT NAME=deltype><%=outS09 %> </SELECT></td>
  </tr>
  <tr class="table_header_center">
    <td width="21%" height="22" class='table_header_center2'>Re-order SEQ</td>
    <td width="21%" height="22" class='table_header_center2'>Amend Date</td>
    <td width="23%" height="22" class='table_header_center2'></td>
    <td width="19%" height="22" class='table_header_center2'></td>
    <td width="16%" height="22" class='table_header_center2'></td>
  </tr>
  <tr class="table_header_center">
    <td width="21%" height="27" class='table_bg_bright'><input type='text' name='reorder' value='<%= reorder_seq %>' size='10' maxlength='10' class='input_text'></td>
    <td width="21%" height="22" class='table_bg_bright'><%=amend_date %></td>
    <td width="23%" height="22" class='table_bg_bright'></td>
    <td width="19%" height="22" class='table_bg_bright'></td>
    <td width="16%" height="22" class='table_bg_bright'></td>
  </tr>
  
  <tr class="table_header_center">
    <td width="21%" height="28" class='table_header_center2'>Item text</td>
...
<table width='840' border='0' cellspacing='1' cellpadding='2' align='center' class='table_bg'>
  <tr class="table_header_center">
    <td width="20%" rowspan="2" class='table_header_center2' height="38">Color</td>
    <td width="67%" colspan="6" class='table_header_center2' height="16">Size</td>
    <td width="13%" rowspan="2" class='table_header_center2' height="38">TOTAL</td>
  </tr>
  <tr class="table_header_center">
    <td width="11%" class='table_header_center2' height="21"><font size="2"><input type='text' value='<%= size_1 %>' name='size1' size='10' maxlength='10' class='input_text'></font></td>
    <td width="11%" class='table_header_center2' height="21"><font size="2"><input type='text' value='<%= size_2 %>' name='size2' size='10' maxlength='10' class='input_text'></font></td>
    <td width="11%" class='table_header_center2'  height="21"><font size="2"><input type='text' value='<%= size_3 %>' name='size3' size='10' maxlength='10' class='input_text'></font></td>
    <td width="11%" class='table_header_center2' height="21"><font size="2"><input type='text' value='<%= size_4 %>' name='size4' size='10' maxlength='10' class='input_text'></font></td>
    <td width="11%" class='table_header_center2' height="21"><font size="2"><input type='text' value='<%= size_5 %>' name='size5' size='10' maxlength='10' class='input_text'></font></td>
    <td width="12%" class='table_header_center2' height="21"><font size="2"><input type='text' value='<%= size_6 %>' name='size6' size='10' maxlength='10' class='input_text'></font></td>
  </tr>
<%=outS%>                                               
</table>
...
<tr>
  <td align='center'>
    <input type='button' value='Amend' onclick='fnSave(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;
