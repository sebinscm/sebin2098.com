...
function fnCSave(frm) { 
  
  if (confirm('Do you really want to save these data?')) {   	
  	 frm.input_flag.value = 'COM';
    frm.action = './order_input.jsp';
    frm.submit();
  }
}
function fnDelete(frm) { 
  po_status=  frm.po_status.value;
  //alert(po_status);
  if ( po_status > '45' ) {
    alert('You cannot delete PO because the selected was confirmed!');
    return;
  }
  if (confirm('Do you really want to save these data?')) {   	
  	 frm.input_flag.value = 'DEL';
    frm.action = './order_input.jsp';
    frm.submit();
  }
}
...
function fnSave(frm) { 
  ...
  if (!frm.size1.value) {
    alert('Input at least one or more Size type!');
    frm.size1.focus();
    return;
  }
  if (!frm.col_1.value) {
...
<form name="form1" method="post">
    ...
    <INPUT TYPE=HIDDEN NAME=po_status value='<%= order_status %>'> 
  ...
  <tr class="table_header_center">
    ...
    <td width="23%" height="23" class='table_bg_bright'><input type='text' onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"  name='unitprice' value='<%=unitprice%>' size='10' maxlength='10' class='input_text_right' >
  ...
  <tr class="table_header_center">
    <td width="21%" height="27" class='table_bg_bright'><SELECT NAME='shiptype'><%=outS10 %></SELECT></td>
  ...
  <tr class="table_header_center">
    ...
    <td width="19%" height="22" class='table_header_center'>Reorder-Seq</td>
  ...
  <tr class="table_header_center">
    ...
    <td width="23%" height="22" class='table_bg_bright'><input type='text' onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"  name='local_price' value='<%=local_price%>' size='10' maxlength='10' class='input_text_right' ></td>
...
<tr>
  <td align='center'>
    <input type='button' value='PO Update' onclick='fnSave(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;
    <input type='button' value='Comments Update' onclick='fnCSave(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;
    <input type='button' value='PO Print' onclick='fnPrint(this.form)'> &nbsp;&nbsp;&nbsp;&nbsp;
     <%
  	   if ( _adminclass.equals("1")) {
     %>
    <input type='button' value='PO Delete' onclick='fnDelete(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;
        <%
      } 
     %>
