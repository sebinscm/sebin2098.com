...
function fnView(po_no_selected) {
  ...
  frmMain.action = "./buyer_po_amend_details.jsp";
  frmMain.submit();
}
...
<FORM name='frmMain' ACTION="buyer_order_amend_input.jsp" METHOD=POST>
...
<TR>
  <td width='10%' class='table_header_center'>PO created date</td>
