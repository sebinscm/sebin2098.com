...
<tr>
  <td width='100%' class='font_small_2'>**Note)
    <ul>
      <li>This is a Pre-Purchase Order only, Not Official PO until it is Confirmed.
      <li>This Pre-Purchase Order represents "Pro forma Purchase Order" status,
      <li>After the Pre-PO is confirmed, the Pre-PO status will be changed as an official PO.</li>
    </ul>
  </td>
</tr>
</table>
...
<table width='100%' border='1' cellspacing='1' cellpadding='2' align='center' bordercolor='black' >
  ...
  <tr class='table_header'>
    ...
    <td width="19%" height="22" >Sub ID</td>
    <td width="16%" height="22" >Work Sheet#</td>
  </tr>
  <tr class='table_list_center'>
    <td width="21%" height="27" ><%=trans_type%></td>
    <td width='21%' ><%= ship_date %></td>
    <td width="23%" height="27" ><%=season%></td>
    <td width="19%" height="27" ><%=subid%></td>
    <td width="16%" height="27" ><%= sup_style_no %></td>
  </tr>
  <tr class='table_header'>
    <td width="21%" height="22" >Material </td>
    <td width="21%" height="22" >BRAND</td>
    <td width="23%" height="22" >Shipping Type</td>
    <td width="19%" height="22" >Reorder#</td>
    <td width="16%" height="22" >Amended Date</td>
  </tr>
  <tr class='table_list_center'>
