...
<tr>
  ...
  <td width='*' class='left_title'>BUYER: Purchase Order</td>
</tr>
<tr>
...
<form name="form1" method="post">
  ...
  <tr class="table_header_center">
    ...
    <td width="19%" height="27" class='table_bg_bright'><input type='text' value='<%= brand %>' name='brand' size='20' maxlength='20' class='input_text'></select></td>
  ...
  <tr class="table_header_center">
    ...
    <td width="21%" height="22" class='table_bg_bright'></td>
