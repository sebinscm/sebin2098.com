...
function fnSubmit(frm) {
  if (!jf_ChkValue(frm.ag_po_no.value)) {
...
<tr>
  ...
  <td width="*" class="left_title"><font size='2'><b> Purchase Order - PT# Managemenr</b></font></td>
</tr>
<tr>
  <td width="700" height="2" colspan="2"><hr width="700"></td>
</tr>
</table>
* The PT# detail is updated at below when you search the PT# by PO#. Please input the search query first. 
<TABLE WIDTH='700' border="0" cellspacing="1" cellpadding="0"  >
<form NAME='frmMain' METHOD='POST' action='./pt_view.jsp'>
