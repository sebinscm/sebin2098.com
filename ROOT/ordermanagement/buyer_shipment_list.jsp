...
function fnView(invoice_no, buyer_id) {
  frmMain.invoice_no.value = invoice_no;
  frmMain.buyer_id.value = buyer_id;
  frmMain.action = "./buyer_shipment_view.jsp";
  frmMain.submit();
}
...
<TR>
 <TD width='15%' class='table_header_center'>Invoice No.</TD>
  ...
  <TD class='table_bg_bright'><select name='ag_confirm_status'>
    <option value='' <%= ag_confirm_status.equals("") ? "selected" : "" %>>All</option>
...
* Select Invoice number to see the Shipment detail.
