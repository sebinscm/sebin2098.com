...
String fromUrl = "order_amend_list.jsp";
...
function fnView(po_no_selected) {
  ...
  frmMain.action = "./po_amend_details.jsp";
  frmMain.submit();
}

function fnViewHistory(po_no_selected) {
  frmMain.po_no_selected.value = po_no_selected;
  frmMain.action  = "./order_amend_updated_history.jsp";
  frmMain.submit();
}
...
<FORM name='frmMain' ACTION="order_amend_list.jsp" METHOD=POST>
...
<TR>
  ...
  <TD width='20%' class='table_bg_bright'>
    ...
    <OPTION value="5" <% if(ag_orderby.equals("5")) out.print("SELECTED"); %>> Amend Date </OPTION>
    </SELECT></TD>
</tr>
<TR>  
  <TD class='table_header_center'>PO#</TD>
  <TD class='table_bg_bright'><input type=text name='ag_po_no' value='<%= ag_po_no %>' size='12' maxlength='11'></TD>
  <TD class='table_header_center'>Style#</TD>
  <TD class='table_bg_bright'><input type=text name='ag_style_no' value='<%= ag_style_no %>' size='12' maxlength='11'></TD>
...
<font color=red> 
* Order Amendment is used if it is necessary to edit PO after confirmation. <br>
* It is only available if PO status is between "Order Confirm (45)" ~ "Produce Top(75)". </font>
