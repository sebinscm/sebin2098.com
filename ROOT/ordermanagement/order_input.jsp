...
if (isSucceeded) {
   if ( input_flag.equals("INSERT") ) {
        strMsg = "Success to create PO#("+pono+")! Press OK/YES to check PO LIST.";
   }
   if ( input_flag.equals("UPDATE") || input_flag.equals("COM") ) {
        strMsg = "Success to update PO#("+pono+")! Press OK/YES to check PO LIST. ";
   }    
      if ( input_flag.equals("DEL") ) {
        strMsg = "Success to delete PO#("+pono+")! Press OK/YES to check PO LIST.";
