...
function fnViewHistory(po_no_selected) {
  frmMain.po_no_selected.value = po_no_selected;
  frmMain.action  = "./buyer_po_updated_history_list.jsp";
  frmMain.submit();
}
function fnViewPT(po_no_selected) {
  frmMain.po_no_selected.value = po_no_selected;
  frmMain.action  = "./buyer_pt_view.jsp";
  frmMain.submit();
}
...
<tr>
  ...
  <td width="*" class="left_title">BUYER : Purchase Order History</td>
</tr>
<tr>
...
<FORM name='frmMain' ACTION="buyer_order_list.jsp" METHOD=POST>
