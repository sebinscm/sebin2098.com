...
function displayLeng( sz, id )
{
    ...
    if (form[id].value.length > sz)
    {
        ...
        {
            alert( 'Up to '+sz+' characters can be put.');
        }
        form[id].value = form[id].value.substring(0, sz);
    }


    document.getElementById(id+'_bytes').innerHTML = form[id].value.length+" characters";
}
</script>
</head>
...
<tr>
  ...
  <td width='*' class='left_title'>BUYER : Pre-Purchase Order</td>
</tr>
<tr>
...
<tr><td>
* (*)marked data must be filled. <br>
* Style Number must be numeric only. <br>
* The PO number will be generated automatically when you create new order as "SubGroup Code+Stylenumber". 	
...
<form name="form1" method="post">
  ...
  <tr class="table_header_center">
    ...
    <td width="21%" height="16" class='table_header_center'>*Style Number</td>
  ...
  <tr class="table_header_center">
    <td width="21%" height="23" class='table_bg_bright'>Auto-Gen<!--input type='text' name='pono' size='15' maxlength='15' class='input_text' disabled='true'--></td>
  ...
  <tr class="table_header_center">
    ...
    <td width="19%" height="22" class='table_header_center'>BRAND</td>
    <td width="16%" height="22" class='table_header_center'>Shipping Type</td>
  </tr>
  <tr class="table_header_center">
    ...
    <td width="19%" height="27" class='table_bg_bright'><input type='text' name='brand' size='20' maxlength='20' class='input_text'></td>
    <td width="16%" height="27" class='table_bg_bright'><SELECT NAME=deltype>
      <OPTION VALUE="SHIP">SHIP</OPTION>
      <OPTION VALUE="AIR">AIR</OPTION>
      </SELECT></td>
  </tr>
  <tr class="table_header_center">
    <td width="21%" height="22" class='table_header_center'>Re-Order SEQ</td>
    <td width="21%" height="22" class='table_header_center'></td>
    <td width="23%" height="22" class='table_header_center'></td>
    <td width="19%" height="22" class='table_header_center'></td>
    <td width="16%" height="22" class='table_header_center'></td>
  </tr>
  <tr class="table_header_center">
    <td width="21%" height="27" class='table_bg_bright'><input type='text' name='reorder' size='10' maxlength='10' class='input_text'></td>
    <td width='21%' height="27" class="table_bg_bright"></td>
    <td width="23%" height="27" class='table_bg_bright'></td>
    <td width="19%" height="27" class='table_bg_bright'></td>
    <td width="16%" height="27" class='table_bg_bright'></td>
  </tr>
  ...
  <tr class="table_header_center">  	 
  	<td class='table_list_no_height' align='center'>Comments<br>(Max. 4000 Characters)</td>    
