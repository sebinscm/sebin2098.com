...
function fnEdit(frm)
{
if (confirm('Do you want to confirm this shipment?')) {	
  frm.action = './buyer_shipment_update.jsp';
  frm.submit();
}
}
...
function fnList(frm) {
  frm.action = './buyer_shipment_list.jsp';
  frm.submit();
}
...
<tr>
  ...
  <td width="*" class="left_title">Shipment 상세내역</td>
</tr>
<tr>
...
* Shipment를 Confirm하시려면 'Shipment Confirm' 버튼을 누르세요.
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr>
...
if (isEditable) {
%>
    <input type='button' value='Shipment Confirm' onclick='fnEdit(this.form);'>
<%
}
%>    
