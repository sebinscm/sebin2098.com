...
function fnView(sampleNo,buyer,sequenceNo) {
  ...
  document.frmMain.buyer_id.value = '<%= scmid %>';
   document.frmMain.sequence_no.value = sequenceNo;
  document.frmMain.action = './sample_sheet_detail.jsp';
...
<tr>
  ...
  <td width="*" class="left_title">Sample Spec sheet Management</td>
</tr>
<tr>
...
<FORM NAME=frmMain action="sample_sheet_list.jsp" METHOD=POST >
...
* Click the Sample number to see the Sample Detail. 
...
<TD width=10%><FONT size=2>Sample Number  </FONT></TD>
<TD width=3%><FONT size=2>SGR</FONT></TD>
<TD width=3%><FONT size=2>Season </FONT></TD>
<TD width=3%><FONT size=2>Date </FONT></TD>
<TD width=3%><FONT size=2>Buyer ID </FONT></TD>
<TD width=20%><FONT size=2>Buyer Name </FONT></TD>
<TD width=20%><FONT size=2>Sample Sheet </FONT></TD>
<TD width=20%><FONT size=2>Request Sheet </FONT></TD>
<TD width=20%><FONT size=2>Amend Sheet </FONT></TD>
<TD width=3%><FONT size=2>Sending Date  </FONT></TD>
<TD width=15%><FONT size=2>Status</FONT></TD>
<TD width=3%><FONT size=2>Style Number </FONT></TD>
</tr>
<%=outS%>
</FORM>
