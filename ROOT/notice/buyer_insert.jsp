...
String subject = "";
String creator_id = scmid;
String creator = scmnm; 
String creator_email = _buyer_email;
String creator_home = "";
String create_date = "";
String contents = "";
String fileName = "";
...
<tr>
  ...
  <FORM name="hwang_bbs" enctype="multipart/form-data" action="buyer_insert_check.jsp" method="post" onSubmit="return validateSubmit()">
  <TABLE width="80%" border="0" align='center'>
    ...
    <TR>
      ...
      <TD width="72%"><INPUT type="file" name="file" size="30" value="<%=CheckNull(fileName) %>"></TD>
    </TR>
    <TR>
      <TD colspan="2">
        <CENTER>
