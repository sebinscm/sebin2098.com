...
public class _admin_0note__jsp extends com.caucho.jsp.JavaPage
{
...
// set query
sql = " select  d.cr_shortname, "
    + "         to_char(a.inv_date, 'yyyymmdd'), "
    + "         a.inv_no, "
    + "         a.brand, "
    + "         a.pic, "
    + "         a.po_inv_no, "
    ...
    + "           on c.cre_accountcode = d.cre_accountcode "
...
if (ag_po_no.length() > 0 || ag_inv_no.length() > 0 || ag_style_no.length() > 0) {
  ...
  if (ag_supplier.length() > 0) {
    sql += " and      c.cre_accountcode = '" + ag_supplier + "' ";
  }
...
sql += " group by d.cr_shortname, to_char(a.inv_date, 'yyyymmdd'), a.inv_no, a.brand, a.pic, a.po_inv_no, a.inv_status, a.del_type ";
...
try {
  ...
  System.out.println("Exception in admin_note : " + e.getMessage());
  throw e;
} finally {
  if (connPronto != null) {
    dataProcess = new DataProcess();
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/admin_note.jsp"), 3685092299830104528L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
