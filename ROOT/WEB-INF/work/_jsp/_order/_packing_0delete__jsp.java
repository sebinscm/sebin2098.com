...
public class _packing_0delete__jsp extends com.caucho.jsp.JavaPage
{
...
String pack_seq[] = request.getParameterValues("pack_seq");
...
String pack_seqs = "";
for (int i = 0; i < pack_seq.length; i++) {
  if (i > 0) pack_seqs += ",";
  pack_seqs += pack_seq[i];
}
...
try {
  ...
  // delete records
  sql = " delete  packing_t "
      + " where   pack_seq in (" + pack_seqs + ") "
      + " and     sup_id = ? "
      + " and     packing_date = ? "
      + " and     po_no = ? ";
  ...
  System.out.println("packing_t - Delete :(" + packing_date + ", po_no=" + po_no_selected + ", supplier_id=" + supplier_id + ") ===> " + sql);
...
/*
  ...
  pstmt.executeUpdate();
  pstmt.close();
  System.out.println("packing_01t - Delete :(po_no=" + po_no_selected + ") ===> " + sql);
  ...
  pstmt.executeUpdate();
  pstmt.close();
  System.out.println("packing_02t - Delete :(po_no=" + po_no_selected + ") ===> " + sql);
  ...
  pstmt.executeUpdate();
  pstmt.close();
  System.out.println("packing_03t - Delete :(po_no=" + po_no_selected + ") ===> " + sql);
  ...
  pstmt.executeUpdate();
  pstmt.close();
  System.out.println("packing_04t - Delete :(po_no=" + po_no_selected + ") ===> " + sql);
*/
  ...
  System.out.println("Exception packing_delete : " + e.getMessage());
  throw e;
} finally {
  if (pstmt != null) {
...
if (isSucceeded) strMsg = "The data are successfully processed.";
else strMsg = "Packing form delete error! Check input value.";
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/packing_delete.jsp"), 5597013747904716475L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
