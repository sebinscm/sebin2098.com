...
public class _invoice_0confirm_0search__jsp extends com.caucho.jsp.JavaPage
{
...
String ag_month_year = request.getParameter("ag_month_year");
String ag_orderby = request.getParameter("ag_orderby");
if (ag_brand == null) ag_brand = "1";
if (ag_po_no == null) ag_po_no = "";
if (ag_month_year == null) ag_month_year = DateUtil.getToday("MM/yyyy");
...
try {
  ...
  if (actionFlag.equals("AP")) {
    // fix brand
    sql = " select  f.sht_category "
        + " from    xstpu22@pronto b "
        + "         left outer join "
        + "         ( "
    ...
    /*
    // fix receiving month year
    sql = " select  max(gi_date) "
        + " from    packing_04t "
        + " where   po_no in ( "
        + "           select  po_no "
        + "           from    invoice_02t "
    ...
    if (iRet > 0) {
      String giDate = matrix.getRowData(0).getData(0);
      ag_month_year = giDate.substring(4, 6) + "/" + giDate.substring(0, 4);
    }
    */
  }

  // read data
  sql = " select  a.po_order_no, b.xspo_style, d.supplier_stkcd, d.rec_ttl_qty, "
      + "         d.gi_date, d.chk_new, d.rec_ret_qty, d.rec_short_qty, d.packing_qty "
      ...
      //+ "           and     b.gi_date between '" + ag_month_year.substring(3) + ag_month_year.substring(0, 2) + "01' "
      //+ "                                 and '" + ag_month_year.substring(3) + ag_month_year.substring(0, 2) + "31' "
...
for (int i = 0; i < iRet; i++) {
  ...
  String chkNew = matrix.getRowData(i).getData(j++);
  int recRetQty = Integer.parseInt(matrix.getRowData(i).getData(j++));
  int recShortQty = Integer.parseInt(matrix.getRowData(i).getData(j++));
  ...
  outS += "<tr align=center bgcolor='" + (i%2 == 0 ? "#FFFFF0" : "#EEEEE0") + "'>" +
          ...
          "<td> " + style_no + "</td>" +
          "<td><font color='red'>" + giDate.substring(6) + "/" + giDate.substring(4, 6) + "/" + giDate.substring(0, 4) + "</font></td>" +
          ...
          "<td align=right> " + StringUtil.formatNumber(recRetQty, QTY_FORMAT) + "</font> </td>" +
          "<td align=right> " + StringUtil.formatNumber(recShortQty, QTY_FORMAT) + "</font></td>" +
          "</tr>" ;
}
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/invoice_confirm_search.jsp"), -7788753800608731041L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string12 = "'>\n<input type='hidden' name='po_no_selected'>\n<TR>\n  <TD><font color=blue size=2 >* PO number needed for invoicing will be listed once goods have been received our Distribution Centre.</font></TD>\n</TR>\n<TR>\n  <td><font color=blue size=2 >* Please contact our Finance Department (02 8458 6200 or accounts@ffb.net.au)\n    regarding any invoice issues.</font></td>\n</TR>\n<TR>\n  <td><font color=red size=2 >* Invoice date must not be earlier than the goods received date.\n    Should this happen the invoice date will be based on the date recorded in the SCM system.</font></td>\n</TR>\n</TABLE>\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n<tr>\n  <td width=\"100%\" height=\"15\"></td>\n</tr>\n</table>\n<!--TABLE WIDTH=700 border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" class=\"table_bg\">\n<TR>\n  <TD width='15%' class='table_header_center'>Brand</TD>\n  <TD width='25%' class='table_bg_bright'><SELECT NAME=ag_brand ".toCharArray();
