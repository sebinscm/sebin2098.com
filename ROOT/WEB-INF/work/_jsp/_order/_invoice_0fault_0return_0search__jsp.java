...
public class _invoice_0fault_0return_0search__jsp extends com.caucho.jsp.JavaPage
{
...
sql = " select  to_char(a.po_invoice_date, 'dd/mm/yyyy'), "
    ...
    + " order by a.po_invoice_date, a.po_order_no ";
//out.println(sql);
...
for (int i = 0; i < iRet; i++) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/invoice_fault_return_search.jsp"), -3865668614251252996L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
