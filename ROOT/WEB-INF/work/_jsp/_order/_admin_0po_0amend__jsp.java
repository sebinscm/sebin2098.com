...
public class _admin_0po_0amend__jsp extends com.caucho.jsp.JavaPage
{
...
if (ag_po_no.length() == 0 && ag_style_no.length() == 0 && ag_supplier.length() > 0) {
  sql += " and     a.cre_accountcode = '" + ag_supplier + "' ";
}

sql += " order by to_date(b.amendment_date, 'dd/mm/yyyy') desc, a.po_order_no ";
//out.println(sql);
...
try {
  ...
  System.out.println("Exception in admin_po_amend : " + e.getMessage());
  throw e;
} finally {
  if (connPronto != null) {
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/admin_po_amend.jsp"), 78777259246981593L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
