...
public class _invoice_0search__jsp extends com.caucho.jsp.JavaPage
{
...
sql = " select  " +
      ...
      " where a.sup_id = b.id and a.sup_id = '" + scmid + "'" ;
...
if (iRet > 0 ) {
  for (i=0; i < iRet; i++) {
    ...
    outS += "<tr bgcolor=" + color_code + ">" +
            ...
            "<td align=center > <font size=2> <a href=\"javascript:fnView('" + invoice_no + "', '" + supplier_id + "')\">" + invoice_no + "</font></td>" +
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/invoice_search.jsp"), 1547420607313125825L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string4 = ">02</OPTION>\n  <OPTION ".toCharArray();
    _jsp_string8 = ">06</OPTION>\n  <OPTION ".toCharArray();
