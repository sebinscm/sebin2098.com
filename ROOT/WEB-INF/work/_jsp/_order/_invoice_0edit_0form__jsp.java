...
for (int i = 0; i < iRet; i++) {
  ...
  double air_price = Double.parseDouble(matrix.getRowData(i).getData(j++));
  ...
  outS += "<tr align='right' bgcolor='" + (i%2 == 0 ? "#FFFFF0" : "#EEEEE0") + "'>" +
          ...
          "<td>$" + StringUtil.formatNumber(air_price, MONEY_FORMAT) + "</td>" +
          ...
          "<td>$" + StringUtil.formatNumber(air_price_sum, MONEY_FORMAT) + "</td>" +
          "<td>$" + StringUtil.formatNumber(amount, MONEY_FORMAT) + "</td>" +
          "</tr>" ;
}
...
if (isEditable && scmid != null) {
      ...
      out.print(( StringUtil.formatNumber(total_air_price_sum, MONEY_FORMAT) ));
      out.write(_jsp_string24, 0, _jsp_string24.length);
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/invoice_edit_form.jsp"), -5421848196997182964L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
