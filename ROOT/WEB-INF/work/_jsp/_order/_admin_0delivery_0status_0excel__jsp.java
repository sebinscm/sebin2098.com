...
public class _admin_0delivery_0status_0excel__jsp extends com.caucho.jsp.JavaPage
{
...
sql = " select  k.shm_description, "
    ...
    + "         left outer join shipment_02t@scm l "
    + "           on h.po_no = l.po_no "
    + "         left outer join shipment_01t@scm m "
    + "           on l.invoice_no = m.invoice_no "
    + "           and l.supplier_id = m.supplier_id "
    + "         left outer join vg_common_code@scm i "
    + "           on m.shipping_port = i.code "
    ...
    + " and     upper(g.cr_shortname) not like 'APESS%' ";
...
for (int i = 0; i < iRet; i++) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/admin_delivery_status_excel.jsp"), -8474405598073676587L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
