...
public class _shipment_0issue_0list__jsp extends com.caucho.jsp.JavaPage
{
...
sql = " select  a.po_order_no, "
    ...
    + (!ag_po_no.equals("") ? " and    a.po_no in (" + sql_po_no + ") " : "")
    ...
    + (!ag_from_date.equals("") ? " and     b.ex_factory_date >= to_date('" + ag_from_date + "', 'dd/mm/yyyy') " : "")
    + (!ag_to_date.equals("") ? " and     b.ex_factory_date <= to_date('" + ag_to_date + "', 'dd/mm/yyyy') " : "")
    + (!ag_po_no.equals("") ? " and    a.po_order_no in (" + ag_po_no + ") " : "")
...
if (fromUrl != null && fromUrl.indexOf("shipment_edit_form.jsp") >= 0) {
      ...
      out.print(( fromUrl.indexOf("shipment_edit_form.jsp") >= 0 ? "Add POs To Shipment" : "Create Shipment" ));
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/shipment_issue_list.jsp"), -8093824835051643720L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
