...
public class _admin_0delivery_0status_0list__jsp extends com.caucho.jsp.JavaPage
{
...
if (ag_brand == null) ag_brand = (_admingroup.equals("B") ? _brand : "");
...
// query for non-apess supplier list
sql2 =  " select  id, name "
      + " from    login_01t a "
      + " where   user_group = 'F' "
      + " and     not exists "
...
sql3 =  " select  distinct a.po_user_name, b.sys_description "
      ...
      + "                    and y.shm_type = 3 "
      + "         ) e "
      + "           on d.xspo_stock_group = e.stock_group "
      ...
      + "         ) "
      + (_admingroup.equals("B") ? " and    e.sht_category = '" + ag_brand + "' " : "")
      + " order by b.sys_description ";

/*
// query for shipping port list
sql4 =  " select  a.code, a.code_name, b.code_name "
...
try {
  ...
  // brand list
  dataProcess.RetrieveData(sql5, matrix5, connScm);
...
for (int i = 0; i < iRet; i++) {
  ...
  String shipping_port = matrix.getRowData(i).getData(j++);
  ...
  outS += "<tr align='center' bgcolor='" + colour_code + "'>"
        ...
        + " <td>" + delivery_date + "</td>"
        + " <td>" + (shipping_port_name.equals("") ? "" : shipping_country_name + " - " + shipping_port_name) + "</td>";
  ...
  if (!_admingroup.equals("A")) {
    ...
    shippingPortOptions += "<option value=''";
    if (shipping_port.equals("")) {
      shippingPortOptions += " selected";
      isFound = true;
    }
    shippingPortOptions += "></option>";
  
    for (int k = 0; k < iRet4; k++) {
      if (!isFound && shipping_port.equals(matrix4.getRowData(k).getData(0))) {
        shippingPortOptions += "<option value='" + matrix4.getRowData(k).getData(0) + "' selected>"
                          + matrix4.getRowData(k).getData(2) + " - " + matrix4.getRowData(k).getData(1) + "</option>";
        isFound = true;
      } else {
        shippingPortOptions += "<option value='" + matrix4.getRowData(k).getData(0) + "'>"
                             + matrix4.getRowData(k).getData(2) +  " - " + matrix4.getRowData(k).getData(1) + "</option>";
      }
    }
...
String userBrandOptions = (_admingroup.equals("B") && !_brand.equals("") ? "" : "<option value='' " + (ag_brand.equals("") ? "selected" : "") + ">All</option>");
...
out.println(CopyRightLogo());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("order/admin_delivery_status_list.jsp"), -956306332668286996L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
