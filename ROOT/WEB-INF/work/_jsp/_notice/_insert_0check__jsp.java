...
public class _insert_0check__jsp extends com.caucho.jsp.JavaPage
{
...
String docRoot = "/home/scm/public_html/notice";
...
if(oper_type == null)
{
	...
	InsertBBS(conn, table_name, bbs_id, subject, creator, password, creator_email, creator_home, contents, fileName, fileSize, p_bbs_id, p_level, p_serial);
}
//--------------------------------------------------------
//--------------------------------------------------------
...
else if(oper_type.equals("ans"))
{
	...
	InsertBBS(conn, table_name, bbs_id, subject, creator, password, creator_email, creator_home, contents, fileName, fileSize ,p_bbs_id, p_level+1, p_serial+1);
}
...
out.println(Redirect(url));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("notice/insert_check.jsp"), -2388978917224922121L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
