...
try {
  ...
  sql = "SELECT adminname, password, nvl(ceil(sysdate - pw_date), 91) " +
        " FROM  admin_02t " +
        " WHERE adminid = '" + otherid + "' ";
  ...
  int j = 0;
  othername = matrix.getRowData(0).getData(j++);
  ...
  session.putValue("otherid", otherid);
  session.putValue("othername", othername);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("pnl/login.jsp"), 9039780183002589459L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
