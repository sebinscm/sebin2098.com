...
public class _delivery_0status_0save__jsp extends com.caucho.jsp.JavaPage
{
...
sql1 =  " insert  into delivery_status_01t "
      ...
      + "           creator, created_date, modifier, modified_date "
      + "         ) "
      + " values  ( "
...
sql2 =  " update  delivery_status_01t "
      + " set     handover_date = decode(handover_yn, 'Y', handover_date, to_date(?, 'dd/mm/yyyy')), "
      + "         handover_yn = decode(handover_yn, 'Y', handover_yn, ?), "
      + "         cutoff_date = decode(cutoff_yn, 'Y', cutoff_date, to_date(?, 'dd/mm/yyyy')), "
      + "         cutoff_yn = decode(cutoff_yn, 'Y', cutoff_yn, ?), "
      + "         departure_date = decode(departure_yn, 'Y', departure_date, to_date(?, 'dd/mm/yyyy')), "
      + "         departure_yn = decode(departure_yn, 'Y', departure_yn, ?), "
      + "         arrival_date = decode(arrival_yn, 'Y', arrival_date, to_date(?, 'dd/mm/yyyy')), "
      + "         arrival_yn = decode(arrival_yn, 'Y', arrival_yn, ?), "
      + "         collecting_date = decode(collecting_yn, 'Y', collecting_date, to_date(?, 'dd/mm/yyyy')), "
      + "         collecting_yn = decode(collecting_yn, 'Y', collecting_yn, ?), "
      + "         delivery_date = decode(delivery_yn, 'Y', delivery_date, to_date(?, 'dd/mm/yyyy')), "
      + "         delivery_yn = decode(delivery_yn, 'Y', delivery_yn, ?), "
      + "         modifier = ?, "
...
try {
  ...
  System.out.println("Exception delivery_status_save : " + e.getMessage());
  throw e;
} finally {
  if (pstmt1 != null) {
...
if (isSucceeded) strMsg = "The data are successfully processed.";
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("pnl/delivery_status_save.jsp"), -5845279947087180421L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string0 = "\n\n\n\n\n".toCharArray();
    _jsp_string11 = "\");\nform1.action = './delivery_status_list.jsp';\nform1.submit();\n</script>\n</BODY>\n</HTML>\n".toCharArray();
