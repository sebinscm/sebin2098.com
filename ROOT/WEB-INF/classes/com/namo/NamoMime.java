	...
	public void saveFile() throws MimeDecodeException
	{
		...
		for(i = 1; i < decodePart.size(); i++)
		{
			...
			try
			{
				...
				// Modifid by Dylan
				// 22.11.2006
				// part의 name이 null일 경우 ..
				// ContentType에서 name을 읽어온다.
				// ex, Content-Type: image/jpg; name="thunderb_t.jpg"
				if (part.getName() == null) {
					String contentType = part.getContentType();
					int idx = contentType.indexOf("name");
					if (idx != -1) {
						String tmpName = contentType.substring(contentType.indexOf("\"") + 1, contentType.length() - 1);
						//System.out.println(tmpName);
						part.setName(tmpName);
					}
				}
				////////////////////////////////////////////////////////////////
