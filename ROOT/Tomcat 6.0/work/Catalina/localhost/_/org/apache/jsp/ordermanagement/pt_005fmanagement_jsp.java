...
public final class pt_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if ( iRet3 > 0 ) {
   ...
   outS2 +="<tr align='center' ><td align='center' colspan='3' ><font color=red>There is no PT# information! </font></td></tr>";
      ...
      out.write("  if (!jf_ChkValue(frm.po_no_selected.value)) {\n");
      out.write("    alert(\"Input PO#.\");\n");
      ...
      out.write("  frm.reset();\n");
      out.write("  frm.seqno.readOnly = true;\n");
      out.write("  frm.seqno.style.backgroundColor = '#e8e8e8';\n");
      out.write("  frm.pt_date.focus();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnSave(frm) {\n");
      out.write("  if (!jf_ChkValue(frm.pt_date.value)) {\n");
      out.write("    alert('Enter PT# date!');\n");
      out.write("    frm.pt_date.select();\n");
      out.write("    return;\n");
      out.write("  }\n");
      out.write(" if (!jf_ChkValue(frm.pt_info.value)) {\n");
      out.write("    alert('Input note!');\n");
      out.write("    frm.pt_info.select();\n");
      out.write("    return;\n");
      out.write("  }\n");
      out.write("  if (confirm('Do you really want to save these data?')) {\n");
      out.write("    frm.action = './pt_update.jsp';\n");
      out.write("    frm.submit();\n");
      out.write("  }\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnDelete(frm) {\n");
      out.write("  if (frm.actionFlag.value != 'U' || !frm.seqno.value) {\n");
      out.write("    alert('Select PT# first to be deleted!');\n");
      out.write("    return;\n");
      out.write("  }\n");
      out.write("\n");
      ...
      out.write("    seqno.value = params[j++];\n");
      out.write("    pt_date.value = params[j++];\n");
      out.write("    pt_info.value = params[j++];\n");
      out.write("\n");
      out.write("    actionFlag.value = 'U';\n");
      out.write("    seqno.readOnly = true;\n");
      out.write("    seqno.style.backgroundColor = '#e8e8e8';\n");
      out.write("  }\n");
      out.write("}\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\"><font size='2'><b> Purchase Order - PT# Management</b></font></td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      out.write("  <td width=\"700\" height=\"2\" colspan=\"2\"><hr width=\"700\"></td>\n");
      out.write("</tr>\n");
      out.write("</table>\n");
      out.write("* Search PO# first then update its detail from the list below. Please input search query. \n");
      out.write("<TABLE WIDTH='700' border=\"0\" cellspacing=\"1\" cellpadding=\"0\"  >\n");
      out.write("<form NAME='frmMain' METHOD='POST' action='./pt_management.jsp'>\n");
      out.write("<TR>\n");
      ...
      out.write("    <td width=\"19%\" height=\"22\" >Manufacturer</td>\n");
      out.write("    <td width=\"16%\" height=\"22\" >Supplier sty#</td>\n");
      out.write("  </tr>\n");
      out.write("  <tr class='table_list_center'>\n");
      ...
      out.write("    <td width=\"19%\" height=\"22\" c>Local Price</td>\n");
      ...
      out.write("  <td colspan=\"2\">비 고 </td>\n");
      out.write("</tr>\n");
      out.print( outS2 );
      out.write("\n");
      out.write("</table>\n");
      out.write("<font size=2 color=blue > 3) Click \"Create New\" button to add new PT#. </font><br>\n");
      out.write("*Click 'seq' coloum to edit PT# detail then save it.\n");
      out.write("<table width='700' border='0'  cellspacing='0' cellpadding='0'>\n");
      out.write("<form name='form1' method='post'>\n");
      out.write("<input type='hidden' name='actionFlag' value='I'>\n");
      out.write("<input type='hidden' name='po_no' value='");
      out.print( pono );
      out.write("'>\n");
      ...
      out.write("'>\t\n");
      out.write("<tr>\n");
      out.write("  <td width='20%' class='table_header_center'>SEQ(*)</td>\n");
      out.write("  <td width='30%' bgcolor = '#e8e8e8' ><input type='text' name='seqno' size='30' maxlength='10' readonly ></td>\n");
      out.write("  <td width='20%' class='table_header_center'>PT# DATE (*)</td>\n");
      out.write("  <td width='30%' class='table_bg_bright'><input type='text' name='pt_date' size='10' value='");
      out.print( pt_date );
      out.write("' style='cursor:hand' readonly\n");
      out.write("    onclick=\"javascript:popFrame.fPopCalendar(this, this, document.all['popCal'], 'RIGHT', event);\"><a href=\"javascript:fnClearDate(form1.pt_date)\"></td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      out.write("  <td class='table_header_center'>Note</td>\n");
      out.write("  <td class='table_bg_bright' colspan=\"3\"><input type='text' name='pt_info' size='100' maxlength='100'></td>\n");
      out.write("</tr>\n");
      out.write("</table>\n");
      out.write("<table width='700' border='0'  cellspacing='0' cellpadding='0'>\n");
      out.write("<tr>\n");
