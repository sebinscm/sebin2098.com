...
public final class buyer_005forder_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String fromUrl="./buyer_order_list.jsp";
...
sql = " select  a.order_no, "
    ...
    + "         a.supplier_name, "
    + "         a.order_status, "
    + "         date_format(a.confirm_date, '%Y/%m/%d'),ifnull(a.total_qty,0), b.code_name,a.sgr, ifnull(a.vendor_price,0),  (a.total_qty * a.vendor_price) total_amount  "
    + " from   purchase_order a, vg_common_code b  "
    + " where  a.backorder_flag = 'N' " 
    + "           and a.order_status = b.code and type='ORDER_STATUS' and b.use_yn='Y'  " ;
...
sql += " and    a.created  between str_to_date('" + ag_from_date + "', '%Y/%m/%d') and str_to_date('" + ag_to_date + "', '%Y/%m/%d') ";
  ...
  if (ag_status.equals("")) {    
      sql += " and    a.order_status  between '40' and '99'  ";
  } else {
...
String sql3 = " select code,code_name  from vg_common_code " +
                   " where type='ORDER_STATUS' and use_yn='Y'  and code between '40' and '99' order by sort_order ";
try {
...
for (int i = 0; i < iRet; i++) {
  ...
  outS += "<tr align='center' bgcolor='" + colour_code + "'>"
        ...
        + " <td>" + po_status_nm + "</td>" 
         + " <td>" + created_date + "</td>"
        + "  <td><a href=\"javascript:fnViewPT('" + po_no + "')\">  View PT# Details </a></td>"  
...
for (int i = 0; i < iRet3; i++) {
  ...
  statusList += "<option value='"+ code + "'" 
      ...
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewComments(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./buyer_po_comments_list.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewHistory(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./buyer_po_updated_history_list.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("function fnViewPT(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./buyer_pt_view.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">BUYER : Purchase Order History</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("<FORM name='frmMain' ACTION=\"buyer_order_list.jsp\" METHOD=POST>\n");
 ...
 if(ag_orderby.equals("5")) out.print("SELECTED"); 
      ...
      out.write("  <TD>Confirm Date</TD>\n");
      out.write("  <TD>PT# Detail</TD>\n");
      out.write("  <TD>Comments</TD>\n");
      out.write("  <TD>History</TD>\n");
