...
public final class cost_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet3; i++) {
  ...
  statusList += "<option value='"+ code + "'" 
      ...
      out.write("}\n");
      out.write("\n");
      out.write("function fnView(po_no_selected,style_selected,buyer_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.style_selected.value = style_selected;\n");
      out.write("  frmMain.buyer_selected.value = buyer_selected;\n");
      out.write("  frmMain.action = \"./cost_details_screen.jsp\";\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">Production Cost Management</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("</tr>\n");
      out.write("</table>\n");
      out.write("** To see the cost detail, Search the target then select the style.\n");
      ...
      out.write("<input type='hidden' name='style_selected'>\n");
      out.write("<input type='hidden' name='buyer_selected'>\n");
