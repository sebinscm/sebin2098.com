...
public final class payment_005fedit_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet2; i++) {
  ...
  outS2 += "<tr align='right' bgcolor='" + (i%2 == 0 ? "#FFFFF0" : "#EEEEE0") + "'>" +
   ...
   outS2 +=  "<tr align='right' bgcolor='#F6CECE'><td align='center'>&nbsp;</td><td align='center'>입금계</td>" +
      ...
      out.write("{\n");
      out.write("  if (confirm('해당 Invoice번호로 해당Buyer에게 대금청구를 하시겠습니다?')) {\n");
      ...
      out.write("}\n");
      out.write("\n");
      out.write("function fnAdd(frm) {\n");
      out.write("\tif (confirm('Payment에 대한 입금을 추가하시겠습니까?')) {\n");
      out.write("\t\tif (!frm.pay_amt.value) {\n");
      out.write("\t\t\t   if (!frm.pay_date.value) {\n");
      ...
      out.write("\t\t  }\n");
      out.write("\t  }  \n");
      out.write("\t  if ( frm.close_yn.value = 'Y' ) {\n");
      out.write("\t      if (! confirm('Payment마감을 선택하셨습니다.마감이 되면 수정이 불가능합니다. 마감을 하시겠습니까?')) {\n");
      out.write("\t          return;\t\n");
      out.write("\t      }\n");
      out.write("\t  }\n");
      out.write("\t  frm.actionFlag.value = 'ADD';\n");
      out.write("\t  frm.action = './admin_payment_update.jsp';\n");
      out.write("\t  frm.submit();\n");
      out.write("   } \n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnDelete(frm) {\n");
      out.write("  if (frm.seq_no) {\n");
      out.write("    var isSelected = false;\n");
      out.write("\n");
      out.write("    if (frm.seq_no.length) {\n");
      out.write("      for (var i = 0; i < frm.seq_no.length; i++) {\n");
      out.write("        if (frm.seq_no[i].checked) {\n");
      out.write("          isSelected = frm.seq_no[i].checked;\n");
      out.write("          break;\n");
      out.write("        }\n");
      out.write("      }\n");
      out.write("    } else {\n");
      out.write("      isSelected = frm.seq_no.checked;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    if (!isSelected) {\n");
      out.write("      alert('삭제할 레코드를 선택하세요!');\n");
      out.write("      return;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    if (confirm('Payment리스트에서 선택한 레코드를 삭제 하시겠습니끼?')) {\n");
      out.write("      frm.target = self.name;\n");
      out.write("      frm.actionFlag.value = 'DEL';\n");
      out.write("      frm.action = './admin_payment_update.jsp';\n");
      out.write("      frm.submit();\n");
      out.write("    }\n");
      out.write("  }\n");
      ...
      out.write("    if (frm.seq_no.length) {\n");
      out.write("      for (var i = 0; i < frm.seq_no.length; i++) {\n");
      out.write("        frm.seq_no[i].checked = frm.tmpCheck.checked;\n");
      out.write("      }\n");
      out.write("    } else {\n");
      out.write("      frm.seq_no.checked = frm.tmpCheck.checked;\n");
      out.write("    }\n");
      out.write("  }\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.print( _adminid != null ? "admin_payment_list" : "admin_payment_list" );
      out.write(".jsp';\n");
      out.write("  frm.submit();\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\"> Payment처리</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("<tr><td>\n");
      out.write("</TABLE>\t\n");
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>[ Buyer대금결재 입력처리 ]</b> <font color=red> ");
      out.print( closed_msg);
      out.write("</font><br>\n");
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;    ** Payment내역을 일자별로 입력하세요. 일시불 입금처리 혹은 분활로 여러번 입금처리가 가능합니다.\n");
 ...
 if (!invoice_status.equals("C") ) {
      ...
      out.write("\n");
      out.write("<tr align='right' bgcolor=\"#FFFFF0\" >\n");
      out.write("    <td align='center'><input type='button' value='추가' onclick='fnAdd(this.form);'></td><td align='center'>");
      out.print(inv_no);
      out.write("</td>\n");
      out.write("    <td><input type='text' onblur=\"extractNumber(this,2,false);\" onkeyup=\"extractNumber(this,2,false);\" onkeypress=\"return blockNonNumbers(this, event, true, false);\"  name='pay_amt' size='10' maxlength='10' class='input_text_right'></td>\n");
      out.write("    <td align='center'><input type='text' name='pay_date'  size='15' readonly class='input_text'>\n");
      out.write("    <img src=\"/img/calendar.gif\" style=\"cursor:hand\" align=\"absmiddle\" onclick=\"javascript:popFrame.fPopCalendar(this, document.form1.pay_date, document.all['popCal'], 'RIGHT', event);\"></td>\n");
      out.write("    <td><input type='text' name='pay_comment'  size='20'  class='input_text'></td>\n");
      out.write("    <td><input type='text' onblur=\"extractNumber(this,2,false);\" onkeyup=\"extractNumber(this,2,false);\" onkeypress=\"return blockNonNumbers(this, event, true, false);\"  name='claim_amt' size='10' maxlength='10' class='input_text_right'></td>\n");
      out.write("    <td align='center'><input type='text' name='claim_date' size='15' readonly class='input_text'>\n");
      out.write("    <img src=\"/img/calendar.gif\" style=\"cursor:hand\" align=\"absmiddle\" onclick=\"javascript:popFrame.fPopCalendar(this, document.form1.claim_date, document.all['popCal'], 'RIGHT', event);\"></td>\n");
      out.write("    <td align=center ><input type='text' name='claim_comment'  size='30'  class='input_text'></td>\n");
      out.write("    <td align='center'><SELECT NAME=close_yn>\n");
      out.write("      <OPTION VALUE=\"Y\" >YES</OPTION>\n");
      out.write("      <OPTION VALUE=\"N\" selected >NO</OPTION>\n");
