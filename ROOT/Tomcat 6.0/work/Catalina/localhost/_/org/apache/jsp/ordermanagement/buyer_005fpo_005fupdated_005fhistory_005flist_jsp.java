...
public final class buyer_005fpo_005fupdated_005fhistory_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
sql = " select  date_format(a.updated, '%Y/%m/%d'),user_name,a.order_no, "
    ...
    + " where  a.backorder_flag = 'N'  and a.order_no ='"+search_pono+"' and a.order_status  between '40' and '99' and a.style is not null order by updated" ; 
...
try {
  ...
  System.out.println("Exception in buyer_po_status : " + e.getMessage());
  throw e;
} finally {
  if (conn != null) {
     conn.close();
...
//        + " <td>" + imgUrl + "</td>"
      ...
      out.write("  frm.action = \"./admin_order_history_list.jsp\"\n");
      out.write("  frm.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewPoline(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action = \"./buyer_poline_updated_history.jsp\";\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">PO edit History</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("  <TD>Qty by Color/Size</TD>\n");
      out.write("</TR>\n");
      out.print( outS );
      out.write("\n");
      out.write("</TABLE>\n");
