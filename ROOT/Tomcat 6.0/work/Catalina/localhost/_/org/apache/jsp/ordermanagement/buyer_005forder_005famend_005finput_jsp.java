...
public final class buyer_005forder_005famend_005finput_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String fromUrl = "buyer_order_amend_input.jsp";
...
sql = " select  a.order_no, "
    ...
    + " where  a.backorder_flag = 'N'  and a.buyer= '"+scmid+"' " ;
...
sql += " and    a.created  between str_to_date('" + ag_from_date + "', '%Y/%m/%d') and str_to_date('" + ag_to_date + "', '%Y/%m/%d') ";
  ...
  if (!ag_status.equals("")) {    
      sql += " and    a.order_status = '" + ag_status + "' ";
  	   ...
  	   sql += " and    a.order_status between '45' and '70' ";
  }	
...
sql2 = " select id, name from login_01t  where user_type = 'S' order by name ";
// ORDER STATUS
String sql3 = " select code,code_name  from vg_common_code " +
                   " where type='ORDER_STATUS' and code between '45' and '70'  and use_yn='Y' order by sort_order ";
try {
...
for (int i = 0; i < iRet3; i++) {
  ...
  statusList += "<option value='"+ code + "'" 
      ...
      out.write("  frmMain.action = \"./buyer_po_amend_details.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewHistory(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./buyer_amend_updated_history.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("<FORM name='frmMain' ACTION=\"buyer_order_amend_input.jsp\" METHOD=POST>\n");
      ...
      out.write("</TR>\n");
      out.write("<TR>\n");
      out.write("  <td width='10%' class='table_header_center'>PO created date</td>\n");
 ...
 if(ag_orderby.equals("5")) out.print("SELECTED"); 
      ...
      out.write("<font color=red>* Order Amendment is used if it is necessary to edit PO after confirmation. <br>* It is only available if PO status is between \"Order Confirm (45)\" ~ \"Produce Top(75)\".</font>\n");
      ...
      out.write("  <TD>Amend Date</TD>\n");
      out.write("  <TD>Amend History</TD>\n");
