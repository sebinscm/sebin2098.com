...
public final class order_005famend_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String strMsg = "";
String nextUrl = "po_amend_details.jsp";
...
try {
  ...
  sql = " update  purchase_order set"
	  ...
	  sql = " insert  into purchase_order_history"
	      ...
	      + "   COMMENTS,TOTAL_QTY ,ORDER_DATE,PO_TYPE,LOCAL_PRICE,REORDER_SEQ,AMEND_DATE,AMEND_USER ";
...
if (isSucceeded) {   
  ...
  nextUrl = "order_amend_details.jsp";
}
