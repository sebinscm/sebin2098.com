...
public final class order_005famend_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet3; i++) {
  ...
  statusList += "<option value='"+ code + "'" 
      ...
      out.write("  frmMain.action = \"./po_amend_details.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewHistory(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./order_amend_updated_history.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("<FORM name='frmMain' ACTION=\"order_amend_list.jsp\" METHOD=POST>\n");
 ...
 if(ag_orderby.equals("5")) out.print("SELECTED"); 
      ...
      out.write("* Order Amendment is used if it is necessary to edit PO after confirmation. <br>\n");
      out.write("* It is only available if PO status is between \"Order Confirm (45)\" ~ \"Produce Top(75)\". </font>\n");
