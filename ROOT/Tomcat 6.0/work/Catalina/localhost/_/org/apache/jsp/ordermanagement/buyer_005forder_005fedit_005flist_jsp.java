...
public final class buyer_005forder_005fedit_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String fromUrl = "buyer_order_edit_list.jsp";

if (ag_supplier == null) ag_supplier = scmid;
...
sql2 = " select id, name from login_01t  where user_type = 'B' and id = '"+scmid+"' order by name ";
// ORDER STATUS
String sql3 = " select code,code_name  from vg_common_code " +
                   " where type='ORDER_STATUS' and use_yn='Y' and code between '35' and '55' order by sort_order ";
try {
...
for (int i = 0; i < iRet; i++) {
  ...
  outS += "<tr align='center' bgcolor='" + colour_code + "'>"
        ...
        + " <td>" + po_status_nm + "</td>" 
        + " <td>" + created_date + "</td>"
        + "  <td><a href=\"javascript:fnViewComments('" + po_no + "')\">  Comment History </a></td>" 
        + " <td>" + imgUrl + "</td>"
        + "</tr>";
}
...
for (int i = 0; i < iRet3; i++) {
  ...
  statusList += "<option value='"+ code + "'" 
      ...
      out.write("  frm.action = \"./buyer_order_edit_list.jsp\"\n");
      ...
      out.write("  frmMain.action = \"./buyer_po_edit.jsp\";\n");
      ...
      out.write("  {\n");
      out.write("    frm.action=\"./buyer_po_list_excel.jsp\";\n");
      out.write("    //frm.target = hidenFrame.name;\n");
      out.write("    frm.submit();\n");
      out.write("  }\n");
      out.write("}\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">BUYER : Edit Purchase Order</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("</tr>\n");
      out.write("</table>\n");
      out.write("Step 1. Search the PO first from the query dialog box below. <br>\n");
      out.write("Step 2. Then the PO search result will be listed below.<br>\n");
      out.write("Step 3. Select the PO from the search result for editing.\n");
