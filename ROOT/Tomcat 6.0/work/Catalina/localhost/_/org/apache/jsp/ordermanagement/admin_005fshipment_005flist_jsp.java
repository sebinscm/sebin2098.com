...
public final class admin_005fshipment_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < matrix2.getRowCount(); i++) {
  ...
  buyerOptions += "<option value='" + buyerId + "' " + (ag_buyer_id.equals(buyerId) ? "selected" : "")
      ...
      out.write("  frm.action = './admin_shipment_list.jsp';\n");
      out.write("  frm.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnView(invoice_no, buyer_id,supplier_id) {\n");
      out.write("  frmMain.invoice_no.value = invoice_no;\n");
      out.write("  frmMain.buyer_id.value = buyer_id;\n");
      out.write("  frmMain.supplier_id.value = supplier_id;\n");
      out.write("  frmMain.action = \"./shipment_view.jsp\";\n");
      ...
      out.write("<input type='hidden' name='supplier_id'>\n");
      out.write("<TR>\n");
      out.write("  <TD width='15%' class='table_header_center'>Buyer</TD>\n");
      out.write("  <TD width='35%' class='table_bg_bright'><select name='ag_buyer_id'>");
      ...
      out.print( ag_confirm_status.equals("A") ? "selected" : "" );
