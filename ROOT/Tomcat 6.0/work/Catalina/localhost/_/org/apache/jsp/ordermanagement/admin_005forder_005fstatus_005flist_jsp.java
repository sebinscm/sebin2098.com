...
public final class admin_005forder_005fstatus_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet3; i++) {
  ...
  buyerList += "<option value='"+ buyer_id + "'" 
      ...
      out.write("  frmMain.action  = \"./admin_po_status_updated_history.jsp\";\n");
...
if (_admingroup.equals("A")) {
      ...
      out.write("    return;\n");
      out.write("  }\t\n");
      out.write("  if (confirm('Do you want to update selected PO( '+frm.po_no.value+' ) Status?')) {      \t\n");
      out.write("        frm.action = './admin_order_status_save.jsp';\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">Order Status Management </td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
