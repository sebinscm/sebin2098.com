...
public final class admin_005fpayment_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try {
  ...
  if (invoice_status.equals("C") ) {
      closed_msg = " Payment for the Invoice has been processed.!";
  } else {
  	  closed_msg = " Invoice hasn't been issued or the payment is in process.";
      isEditable = true;
  }   
...
for (int i = 0; i < iRet2; i++) {
  ...
  outS2 +=  "<tr align='right' bgcolor='" + (i%2 == 0 ? "#FFFFF0" : "#EEEEE0") + "'>" +                 
   ...
   outS2 +=  "<tr align='right' bgcolor='#F6CECE'><td align='center'>&nbsp;</td><td align='center'>Paid Sum</td>" +
                  "<td>$" + StringUtil.formatNumber( total_paid_sum, MONEY_FORMAT) + "</td>" +
                  "<td align='center'>&nbsp;</td>" +
                 "<td align='center'>Claim Sum</td>" +
                 "<td>$" + StringUtil.formatNumber( total_claim_sum, MONEY_FORMAT) + "</td>" +                 
                  "<td align='center'>Balance Sum</td>" +
      ...
      out.write("  frm.action = './admin_payment_search.jsp';\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\"> Payment Detail</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("'>\n");
      out.write("<TR>\n");
      out.write("  <TD width='150' class='table_header_center'>Invoice#</TD>\n");
      ...
      out.write("</TR>\n");
      out.write("<TR>\n");
      out.write("  <TD class='table_header_center'>Saved Invoice File</TD>\n");
      ...
      out.write("<tr><td>\n");
      out.write("</TABLE>\t\n");
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>[ Buyer Payment Status ]</b> <font color=red> ");
      ...
      out.write("  <TD>Claim Amount</TD>\n");
      out.write("  <TD>Claim Date</TD>\n");
      out.write("  <TD>Description</TD>\n");
      out.write("  <TD>Closed</TD>\n");
      out.write("  <TD>Input Date</TD>\n");
      out.write("  <TD>Input By</TD>\n");
      out.write("</TR>\n");
      out.print( outS2 );
      out.write("\t\n");
      out.write(" <tr>\n");
