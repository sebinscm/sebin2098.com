...
public final class admin_005fpo_005fdetails_005fscreen_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//String fromUrl = "admin_po_details_screen.jsp";
...
sql = "  select  a.id, a.name,a.phone1,a.fax, concat(a.addr1,' ',a.addr2) as addr , " +
 ...
 if ( Integer.parseInt(order_status) < 43 ) {
      ...
      out.write("    <td width=\"16%\" height=\"22\" >Task#</td>\n");
      out.write("  </tr>\n");
      out.write("  <tr class='table_list_center'>\n");
