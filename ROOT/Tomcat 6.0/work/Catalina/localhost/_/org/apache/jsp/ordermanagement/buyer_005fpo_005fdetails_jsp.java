...
public final class buyer_005fpo_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//out.println(po_no);
//out.println(fromUrl);
//out.println(ag_po_no);
//out.println(ag_style_no);
//out.println(ag_orderby);
...
try {
 ...
 // Select PO master  
  sql = "  Select ORDER_NO ,  STYLE , SEASON ,  SGR ,  PGR  , "
	      + "   FABRIC, ITEM_TEXT, SUP_STOCK_CODE, date_format(VENDOR_PRICE,'99.99') ,  date_format(INITIAL_DEL_DATE,'%Y/%m/%d'), "
...
sql = "  select  a.id, a.name,a.phone1,a.fax, concat(a.addr1,' ',a.addr2) as addr , " +
 ...
 if ( Integer.parseInt(order_status) < 43 ) {
      ...
      out.write("<tr>\n");
      out.write("  <td width='100%' class='font_small_2'>**Note)\n");
      out.write("    <ul>\n");
      out.write("      <li>This is a Pre-Purchase Order only, Not Official PO until it is Confirmed.\n");
      out.write("      <li>This Pre-Purchase Order represents \"Pro forma Purchase Order\" status,\n");
      out.write("      <li>After the Pre-PO is confirmed, the Pre-PO status will be changed as an official PO.</li>\n");
      out.write("    </ul>\n");
      out.write("  </td>\n");
      out.write("</tr>\n");
      out.write("</table>\n");
      ...
      out.write("    <td width=\"19%\" height=\"22\" >Sub ID</td>\n");
      ...
      out.write("    <td width=\"19%\" height=\"22\" >Reorder#</td>\n");
      out.write("    <td width=\"16%\" height=\"22\" >Amended Date</td>\n");
      out.write("  </tr>\n");
      out.write("  <tr class='table_list_center'>\n");
      out.write("    <td width=\"21%\" height=\"27\" >");
      out.print(mname);
