...
for (int i = 0; i < iRet; i++) {
  ...
  outS += "<tr align='center' bgcolor='" + colour_code + "'>"
        ...
        + " <td>" + po_status_nm + "</td>" 
        + " <td>" + created_date + "</td>"
        + "  <td><a href=\"javascript:fnViewPT('" + po_no + "')\">  Edit PT# Detail </a></td>"   
...
for (int i = 0; i < iRet3; i++) {
  ...
  statusList += "<option value='"+ code + "'" 
      ...
      out.write("  frmMain.action = \"./admin_po_details.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewComments(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./admin_po_comments_list.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      out.write("function fnViewPT(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action  = \"./pt_management.jsp\";\n");
      out.write("  frmMain.submit();\n");
      out.write("}\n");
      ...
      out.write("</tr>\n");
      out.write("</table>\n");
      out.write("* Select the PO from the search result for editing. .\n");
