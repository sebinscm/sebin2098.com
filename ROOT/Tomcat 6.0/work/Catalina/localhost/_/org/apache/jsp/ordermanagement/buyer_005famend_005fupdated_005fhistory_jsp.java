...
public final class buyer_005famend_005fupdated_005fhistory_jsp extends org.apache.jasper.runtime.HttpJspBase
...
sql = " select  date_format(a.updated, '%Y/%m/%d'),user_name,a.order_no, "
    ...
    + " where  a.backorder_flag = 'N'  and a.style is not null and  a.order_no ='"+search_pono+"' and a.amend_date is not null order by updated" ; 
...
for (int i = 0; i < iRet; i++) {
 ...
 //       + " <td>" + imgUrl + "</td>"
      ...
      out.write("  frm.action = \"./buyer_amend_updated_history.jsp\"\n");
      out.write("  frm.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function fnViewPoline(po_no_selected) {\n");
      out.write("  frmMain.po_no_selected.value = po_no_selected;\n");
      out.write("  frmMain.action = \"./buyer_amend_poline_updated_history.jsp\";\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">PO Amend History</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
