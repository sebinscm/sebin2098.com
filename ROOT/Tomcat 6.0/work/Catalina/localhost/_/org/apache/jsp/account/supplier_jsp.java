  ...
  outS += "<tr align='center' style='background-color:" + bgColor + ";'>"
   ...
   if ( _adminclass.equals("1") && _admingroup.equals("A") ) {   
    ...
    outS += "</tr>";
      ...
      out.print(new_id );
      out.write("';\n");
      out.write("  frm.suppId.readOnly = false;  \n");
      out.write("  frm.suppId.style.backgroundColor = '#ffffff';\n");
      ...
      out.write("    alert('Input buyer Name.');\n");
      ...
      out.write("        var emailEx1 = /^([A-Za-z0-9]{0,1})([A-Za-z0-9-_.]{1,15})([A-Za-z0-9-_.]{0,1})([A-Za-z0-9-_.]{1,15})([A-Za-z0-9]{0,1})(@{1})([A-Za-z0-9_]{1,15})(.{1})([A-Za-z0-9_]{2,10})(.{1}[A-Za-z]{2,10})?(.{1}[A-Za-z]{2,10})?$/;\n");
      out.write("        if(!emailEx1.test(email[i])) {\n");
      out.write("           alert ('E-mail format is incorrect. (Do not use space in your email.)');\n");
      ...
      out.write("  }\t  \n");
      out.write("\n");
      out.write("  if (confirm('Do you really want to update these data?')) {\n");
      ...
      out.write("    alert('Select a buyer you want to delete.');\n");
      out.write("    return;\n");
      out.write("  }\n");
      out.write("\n");
      out.write("  if (confirm('Do you really want to delete the selected buyer?')) {\n");
      ...
      out.write("  if (frm.actionFlag.value != 'U' || !frm.suppId.value) {\n");
      out.write("    alert('Select a buyer you want to initialize.');\n");
      out.write("    return;\n");
      out.write("  }\n");
      out.write("\n");
      out.write("  if (confirm('Do you really want to initialize the selected buyer for password?')) {\n");
      ...
      out.write("    jf_fnSetSelectOption(ship_port, params[j++]);\n");
      out.write("    jf_fnSetSelectOption(user_group, params[j++]);\n");
      ...
      out.write("</tr>\n");
      out.write("<tr>\n");
      out.write("  <td width='3%'><img src='/img/users.gif'></td>\n");
      out.write("  <td width='*' class='left_title'>Buyer Registration</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("* It cannot chance once the Buyer ID is created. If you still want to change the Buyer ID, you have to re-create after delete the existing ID.\n");
      out.write("<br>* Default password will be replaced with '1111' if the password is reset. \n");
      out.write("<br>* Please reset the password when you login first time or when you lost your password.\n");
      out.write("<tr>\n");
      out.write("  <td width='20%' class='table_header_center'>Buyer ID(*)</td>\n");
      out.write("  <td width='30%' class='table_bg_bright'><input type='text' name='suppId'  size='5' maxlength='5'>  </td>\n");
      out.write("  <td width='20%' class='table_header_center'>Buyer Name</td>\n");
      ...
      out.write("  <td class='table_bg_bright'><input type='password' name='password' size='20' maxlength='20'></td>\n");
      out.write("</tr>\n");
      out.write("<tr>  \n");
      ...
      out.write("  <td class='table_bg_bright'><select name=\"ship_port\">");
      out.print( outS03 );
      out.write("</select></td>   \n");
      out.write("</tr>\n");
      out.write("<tr>  \n");
      out.write("  <td class='table_header_center'>PO GROUP</td>\n");
      out.write("  <td class='table_bg_bright'><select name='user_group'>\n");
      out.write("    <option></option>\n");
      out.write("    <option value='F'>PO INPUT=NO </option>\n");
      out.write("    <option value='D'>PO INPUT=YES </option></td>\n");
      out.write("  <td class='table_header_center'>Currency</td>\n");
      out.write("  <td class='table_bg_bright'><select name=\"supplier_class\">");
      out.print( outS01 );
      out.write("</select></td> \n");
      out.write("  <td class='table_header_center'>Disable (Y/N)</td>\n");
      ...
      out.write("<table width='90%' border='0' cellspacing='0' cellpadding='0' align='center'>\n");
      out.write("<tr>\n");
      out.write("  <td height='15'><font color=red>Notice: Please input accurate email address. It is critical that the email shall be used for trading order.</font></td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("<table width='90%' border='0' cellspacing='0' cellpadding='0' align='center'>\n");
      out.write("<tr>\n");
      out.write("  <td>- Click 'ID' to see the buyer's detail. You can see the specific Buyer detail by clicking Buyer ID.</td>\n");
      ...
      out.write("   <td>Contact1</td>\n");
      out.write("   <td>Contact2</td>\n");
      out.write("   <td>Fax </td>\n");
