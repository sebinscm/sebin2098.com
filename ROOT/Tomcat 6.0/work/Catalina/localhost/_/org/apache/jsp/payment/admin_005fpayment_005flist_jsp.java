...
public final class admin_005fpayment_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int k = thisYear - 4; k <= thisYear; k++) {
  optionYears += "<option value='" + k + "' " + (ag_year.equals(k + "") ? "selected" : "") +">" + k + "</option>";
      ...
      out.write("  document.frmMain.action = './payment_edit_form.jsp';\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">Buyer Payement Management</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("<FORM NAME=frmMain action=\"admin_payment_list.jsp\" METHOD=POST >\n");
      ...
      out.write("</table>\n");
      out.write("\n");
      out.write("<TABLE WIDTH=950 border=\"0\" cellspacing=\"1\" cellpadding=\"2\" align=\"center\" class='table_bg'>\n");
      out.write("<TR>\n");
      ...
      out.write("    </SELECT>    \n");
      out.write("  </td>\t\n");
      out.write("  <TD width='10%' class='table_header_center'>Invoiced</TD>\n");
      out.write("  <TD width='5%' class='table_bg_bright' >\n");
      out.write("    <SELECT NAME='ag_yn'>\n");
      out.write("     <OPTION ");
 if(ag_yn.equals("A")) out.print("SELECTED"); 
      out.write(">All</OPTION>\n");
      out.write("     <OPTION ");
 if(ag_yn.equals("Y")) out.print("SELECTED"); 
      out.write(">Y</OPTION>\n");
      out.write("     <OPTION ");
 if(ag_yn.equals("N")) out.print("SELECTED"); 
      out.write(">N</OPTION>\n");
      out.write("    </SELECT>    \n");
      out.write("  </td>\t\n");
 ...
 if(ag_month.equals("12")) out.print("SELECTED"); 
      ...
      out.write("<TD width=3%><FONT size=2>B.ID </FONT></TD>\n");
      out.write("<TD width=15%><FONT size=2>Buyer Name </FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>S.ID </FONT></TD>\n");
      ...
      out.write("<TD width=3%><FONT size=2>Invoiced</FONT></TD>\n");
      out.write("<TD width=5%><FONT size=2>Date Invoiced </FONT></TD>\n");
      out.write("</tr>\n");
      out.print(outS);
      out.write("\n");
      out.write("</FORM>\n");
