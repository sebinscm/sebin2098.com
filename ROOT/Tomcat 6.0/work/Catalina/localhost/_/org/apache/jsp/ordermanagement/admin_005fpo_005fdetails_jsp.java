...
public final class admin_005fpo_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String fromUrl = "admin_po_details.jsp";
...
try {
  ...
  if ( iRet2 > 0 ) {   
	  for (int i = 0; i < iRet2; i++) {
       ...
       if ( i == 0 ) {
	    ...
	    outS += "<tr class='table_header_center'>"
	          ...
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='aqty_1' value='"+qty1[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='aqty_2' value='"+qty2[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='aqty_3' value='"+qty3[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='aqty_4' value='"+qty4[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='aqty_5' value='"+qty5[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='aqty_6'  value='"+qty6[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change()'></td>"
	          + "  <td width='13%' height='16' class='table_bg_bright'><input type='text' name='aqtytot' value='"+siztotal_qty[i]+"' size='5' maxlength='5' class='input_text_right' readonly ></td>"
	          + "</tr>";
	    }
	    if ( i == 1 ) {
	     last_cnt = 2; 
	    outS += "<tr class='table_header_center'>"
	          ...
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='bqty_1' value='"+qty1[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change2()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='bqty_2' value='"+qty2[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change2()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='bqty_3' value='"+qty3[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change2()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='bqty_4' value='"+qty4[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change2()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='bqty_5' value='"+qty5[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change2()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='bqty_6'  value='"+qty6[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change2()'></td>"
	          + "  <td width='13%' height='16' class='table_bg_bright'><input type='text' name='bqtytot' value='"+siztotal_qty[i]+"' size='5' maxlength='5' class='input_text_right' readonly ></td>"
	          + "</tr>";
	    }
	    if ( i == 2 ) {
	     last_cnt = 3; 
	    outS += "<tr class='table_header_center'>"
	          ...
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='cqty_1' value='"+qty1[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change3()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='cqty_2' value='"+qty2[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change3()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='cqty_3' value='"+qty3[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change3()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='cqty_4' value='"+qty4[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change3()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='cqty_5' value='"+qty5[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change3()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='cqty_6'  value='"+qty6[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change3()'></td>"
	          + "  <td width='13%' height='16' class='table_bg_bright'><input type='text' name='cqtytot' value='"+siztotal_qty[i]+"' size='5' maxlength='5' class='input_text_right' readonly ></td>"
	          + "</tr>";
	    }
	    if ( i == 3 ) {
	      last_cnt = 4;  
	    outS += "<tr class='table_header_center'>"
	          ...
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='dqty_1' value='"+qty1[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change4()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='dqty_2' value='"+qty2[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change4()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='dqty_3' value='"+qty3[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change4()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='dqty_4' value='"+qty4[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change4()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='dqty_5' value='"+qty5[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change4()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='dqty_6'  value='"+qty6[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change4()'></td>"
	          + "  <td width='13%' height='16' class='table_bg_bright'><input type='text' name='dqtytot' value='"+siztotal_qty[i]+"' size='5' maxlength='5' class='input_text_right' readonly ></td>"
	          + "</tr>";
	    }
	    if ( i == 4 ) {
	      last_cnt = 5;   
	    outS += "<tr class='table_header_center'>"
	          ...
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='eqty_1' value='"+qty1[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change5()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='eqty_2' value='"+qty2[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change5()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='eqty_3' value='"+qty3[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change5()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='eqty_4' value='"+qty4[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change5()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='eqty_5' value='"+qty5[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change5()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='eqty_6'  value='"+qty6[i]+"' onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change5()'></td>"
	          + "  <td width='13%' height='16' class='table_bg_bright'><input type='text' name='eqtytot' value='"+siztotal_qty[i]+"' size='5' maxlength='5' class='input_text_right' readonly ></td>"
	          + "</tr>";
	    }
	  ...
	  for ( int i = last_cnt+1; i < 6; i++) {
	        ...
	        outS += "<tr class='table_header_center'>"
	          ...
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='"+add_qty1+"'  onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change"+i+"()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='"+add_qty2+"'  onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change"+i+"()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='"+add_qty3+"'  onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change"+i+"()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='"+add_qty4+"'  onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change"+i+"()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='"+add_qty5+"'  onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change"+i+"()'></td>"
	          + "  <td width='11%' height='16' class='table_bg_bright'><input type='text' name='"+add_qty6+"'   onkeypress='return jf_EventNumberCheck();' size='5' maxlength='5' class='input_text_right' onBlur='Change"+i+"()'></td>"
	          + "  <td width='13%' height='16' class='table_bg_bright'><input type='text' name='"+add_tot+"'  size='5' maxlength='5' class='input_text_right' readonly ></td>"
	          + "</tr>";
	  }
	  // 
  } else {
 ...
 if (conn != null) {
    ...
    conn = null;
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("<title>Edit Purchase Order</title>\r\n");
      ...
      out.write("<script language=\"javascript\">\r\n");
      out.write("\r\n");
      out.write("function fnCSave(frm) { \r\n");
      out.write("  \r\n");
      out.write("  if (confirm('Do you really want to save these data?')) {   \t\r\n");
      out.write("  \t frm.input_flag.value = 'COM';\r\n");
      out.write("    frm.action = './order_input.jsp';\r\n");
      out.write("    frm.submit();\r\n");
      out.write("  }\r\n");
      out.write("}\r\n");
      out.write("function fnDelete(frm) { \r\n");
      out.write("  po_status=  frm.po_status.value;\r\n");
      out.write("  //alert(po_status);\r\n");
      out.write("  if ( po_status > '45' ) {\r\n");
      out.write("    alert('You cannot delete PO because the selected was confirmed!');\r\n");
      out.write("    return;\r\n");
      out.write("  }\r\n");
      out.write("  if (confirm('Do you really want to save these data?')) {   \t\r\n");
      out.write("  \t frm.input_flag.value = 'DEL';\r\n");
      out.write("    frm.action = './order_input.jsp';\r\n");
      out.write("    frm.submit();\r\n");
      out.write("  }\r\n");
      out.write("}\r\n");
      ...
      out.write("  }\r\n");
      out.write("  if (confirm('Do you really want to save these data?')) { \r\n");
      out.write("  \tfrm.input_flag.value = 'UPDATE';  \t\r\n");
      out.write("    frm.action = './order_input.jsp';\r\n");
      out.write("    frm.submit();\r\n");
      out.write("  }\r\n");
      out.write("}\r\n");
      ...
      out.write("{ \r\n");
      out.write("  frm.action = \"./admin_order_list.jsp\";  \r\n");
      out.write("  frm.submit(); \r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("  //if (win) {\r\n");
      out.write("    frm.action = './po_print.jsp';  \r\n");
      ...
      out.write("  <td width='*' class='left_title'>Edit Purchase Order</td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr>\r\n");
      ...
      out.write("<tr><td>\r\n");
      out.write("* (*) must be filled in.\tPO Status= ");
      ...
      out.print( fromUrl );
      out.write("' >\r\n");
      out.write("\t<INPUT TYPE=HIDDEN NAME=input_flag  >\r\n");
      ...
      out.print(unitprice);
      out.write("' size='10' maxlength='10' class='input_text_right' >\r\n");
      ...
      out.print(outS08 );
      out.write(" </SELECT></td>\r\n");
      out.write("    <td width=\"19%\" height=\"27\" class='table_bg_bright'><select name=\"subsupplier\">");
      out.print(outS07 );
      out.write("</select></td>\r\n");
      out.write("    <td width=\"16%\" height=\"27\" class='table_bg_bright'><input type='text' name='supstyno' value='");
      out.print( sup_style_no );
      out.write("' size='20' maxlength='20' class='input_text'></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      ...
      out.write("    <td width=\"19%\" height=\"22\" class='table_header_center'>Reorder-Seq</td>\r\n");
      out.write("    <td width=\"16%\" height=\"22\" class='table_header_center'>Amend Date</td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      out.write("    <td width=\"21%\" height=\"27\" class='table_bg_bright'><input type='text' value='");
      out.print( brand );
      out.write("' name='brand' size='20' maxlength='20' class='input_text'></td>\r\n");
      out.write("    <td width=\"21%\" height=\"22\" class='table_bg_bright'><SELECT NAME=deltype>");
      out.print(outS09 );
      out.write(" </SELECT></td>\r\n");
      out.write("    <td width=\"23%\" height=\"22\" class='table_bg_bright'><input type='text' onblur=\"extractNumber(this,2,false);\" onkeyup=\"extractNumber(this,2,false);\" onkeypress=\"return blockNonNumbers(this, event, true, false);\"  name='local_price' value='");
      out.print(local_price);
      out.write("' size='10' maxlength='10' class='input_text_right' ></td>\r\n");
      out.write("    <td width=\"19%\" height=\"22\" class='table_bg_bright'><input type='text' name='reorder' value='");
      ...
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      out.write("    <td width=\"11%\" class='table_header_center' height=\"21\"><font size=\"2\"><input type='text' value='");
      out.print( size_1 );
      ...
      out.write("    <td width=\"12%\" class='table_header_center' height=\"21\"><font size=\"2\"><input type='text' value='");
      out.print( size_6 );
      ...
      out.write("    <input type='button' value='PO Update' onclick='fnSave(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("    <input type='button' value='Comments Update' onclick='fnCSave(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      ...
      out.write("\r\n");
      out.write("    <input type='button' value='PO Delete' onclick='fnDelete(this.form);'> &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("        ");
