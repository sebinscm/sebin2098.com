...
public final class sample_005fsheet_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//out.println(searchSampleNo);
//out.println(searchStyleNo);
  ...
  for (int i=0; i < iRet; i++) {
   ...
   file_name3        = matrix.getRowData(i).getData(j++);
    ...
    outS += "<tr bgcolor=" + color_code + ">" +
            ...
            "<td align=center > <font size=2>" + scmid + " </font></td>" +
...
for (int i = 0; i < iRet6; i++) {
  ...
  searchSupplierOptions += "<option value='" + sid + "'"
      ...
      out.write("  <td width=\"*\" class=\"left_title\">Sample Spec sheet Management</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("<FORM NAME=frmMain action=\"sample_sheet_list.jsp\" METHOD=POST >\n");
      ...
      out.write("  </form>\n");
      out.write("</table>\n");
      out.write("* Click the Sample number to see the Sample Detail. \n");
      ...
      out.write("<TD width=10%><FONT size=2>Sample Number  </FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>SGR</FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>Season </FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>Date </FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>Buyer ID </FONT></TD>\n");
      out.write("<TD width=20%><FONT size=2>Buyer Name </FONT></TD>\n");
      out.write("<TD width=20%><FONT size=2>Sample Sheet </FONT></TD>\n");
      out.write("<TD width=20%><FONT size=2>Request Sheet </FONT></TD>\n");
      out.write("<TD width=20%><FONT size=2>Amend Sheet </FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>Sending Date  </FONT></TD>\n");
      out.write("<TD width=15%><FONT size=2>Status</FONT></TD>\n");
      out.write("<TD width=3%><FONT size=2>Style Number </FONT></TD>\n");
      out.write("</tr>\n");
      out.print(outS);
      out.write("\n");
      out.write("</FORM>\n");
