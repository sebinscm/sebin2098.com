...
public final class buyer_005forder_005famend_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet; i++) {
  ...
  outS += "<tr align='center' bgcolor='" + colour_code + "'>"
      ...
      out.write("  frmMain.action = \"./buyer_amend_details.jsp\";\n");
      ...
      out.write("  <td width=\"*\" class=\"left_title\">Purchase Order Amendment List</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("<FORM name='frmMain' ACTION=\"buyer_order_amend_list.jsp\" METHOD=POST>\n");
      out.write("<input type='hidden' name='po_no_selected'>\n");
      out.write("<input type='hidden' name='fromUrl' value='");
      out.print( fromUrl );
      out.write("'>\n");
      out.write("<TR>\n");
      out.write("  <td width='10%' class='table_header_center'>Amend Date</td>\n");
 ...
 if(ag_orderby.equals("5")) out.print("SELECTED"); 
      ...
      out.write("  <TD>Amendment History</TD> \n");
