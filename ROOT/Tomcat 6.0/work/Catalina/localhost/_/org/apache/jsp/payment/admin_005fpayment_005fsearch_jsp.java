...
public final class admin_005fpayment_005fsearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet3; i++) {
  ...
  buyerList += "<option value='"+ buyer_id + "'" 
      ...
      out.write("<FORM name='frmMain' ACTION=\"admin_payment_search.jsp\" METHOD=POST>\n");
      ...
      out.write("</SELECT></td>\n");
      out.write("  <td width=\"10%\" class=\"table_header_center\">Invoice No.</td>\n");
