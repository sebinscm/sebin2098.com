...
public final class company_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i = 0; i < iRet; i++) {
  ...
  outS += "<tr align='center' style='background-color:" + bgColor + ";'>"
      ...
      out.write("    frm.action = './company_save.jsp';\n");
      ...
      out.write("  <td width='*' class='left_title'>Company Profile Management</td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      ...
      out.write("* Registered Company ID cannot be changed. Contact System Administrator to change ID. <br>\n");
      out.write("  \n");
      out.write("<tr>\n");
      out.write("  <td width='20%' class='table_header_center'>Company ID(*)</td>\n");
      out.write("  <td width='30%' class='table_bg_bright'><input type='text' name='suppId' size='5' maxlength='5'></td>\n");
      out.write("  <td width='20%' class='table_header_center'>Company Name</td>\n");
