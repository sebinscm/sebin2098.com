...
try {
 ...
 // get buyer code
  ...
  if (conn != null) {conn.close();}	
      ...
      out.write("    return;\r\n");
      out.write("  }\r\n");
      out.write("  if (!frm.local_price.value) {\r\n");
      out.write("    alert('Input Local Price!');\r\n");
      out.write("    frm.local_price.focus();\r\n");
      out.write("    return;\r\n");
      out.write("  }\r\n");
      ...
      out.write("    alert('Input reorder sequence!');\r\n");
      out.write("    frm.reorder.focus();\r\n");
      out.write("    return;\r\n");
      out.write("  }\r\n");
      out.write("  if (!frm.size1.value) {\r\n");
      out.write("    alert('Input at least one Size type!');\r\n");
      out.write("    frm.size1.focus();\r\n");
      out.write("    return;\r\n");
      out.write("  }\r\n");
      out.write("  if (!frm.col_1.value) {\r\n");
      out.write("    alert('Input at least one color and qty!');\r\n");
      ...
      out.write("        {\r\n");
      out.write("            alert( 'You can input '+sz+' characters.');\r\n");
      out.write("        }\r\n");
      ...
      out.write("  <td width='*' class='left_title'>Create Pre-Purchase Order</td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr>\r\n");
      ...
      out.write("<tr><td>\r\n");
      out.write("(*)marked item must be filled in. Style# should be numeric only. Style# will be create as \"SubGroup Code+Style#\" when the PO is created. \t\r\n");
      ...
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      out.write("    <td width=\"21%\" height=\"23\" class='table_bg_bright'>Auto-Create<!--input type='text' name='pono' size='15' maxlength='15' class='input_text' disabled='true'--></td>\r\n");
      ...
      out.write("    <td width=\"16%\" height=\"22\" class='table_header_center'>Task Number</td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      ...
      out.print(outS07);
      out.write("</select></td>\r\n");
      out.write("    <td width=\"16%\" height=\"27\" class='table_bg_bright'><input type='text' name='supstyno' size='20' maxlength='20' class='input_text'></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      ...
      out.write("    <td width=\"23%\" height=\"22\" class='table_header_center'>Local Price(RMB)</td>\r\n");
      out.write("    <td width=\"19%\" height=\"22\" class='table_header_center'>Re-Order SEQ</td>\r\n");
      out.write("    <!--td width=\"16%\" height=\"22\" class='table_header_center'>PT#3 DATE</td-->\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      out.write("    <td width=\"21%\" height=\"27\" class='table_bg_bright'><input type='text' name='brand' size='20' maxlength='20' class='input_text'></td>\r\n");
      out.write("    <td width='21%' height=\"27\" class=\"table_bg_bright\"><SELECT NAME=deltype>\r\n");
      out.write("      <OPTION VALUE=\"SHIP\">SHIP</OPTION>\r\n");
      out.write("      <OPTION VALUE=\"AIR\">AIR</OPTION>\r\n");
      out.write("      </SELECT></td>\r\n");
      out.write("    <td width=\"23%\" height=\"27\" class='table_bg_bright'><input type='text' onblur=\"extractNumber(this,2,false);\" onkeyup=\"extractNumber(this,2,false);\" onkeypress=\"return blockNonNumbers(this, event, true, false);\"  name='local_price' size='10' maxlength='10' class='input_text_right'></td>\r\n");
      out.write("    <td width=\"19%\" height=\"27\" class='table_bg_bright'><input type='text' name='reorder' size='10' maxlength='10' class='input_text'></td>\r\n");
      out.write("    <!--td width=\"16%\" height=\"27\" class='table_bg_bright'><input type='text' name='pt3' size='20' maxlength='20' class='input_text'></td-->\r\n");
      out.write("  </tr>\r\n");
      out.write("  \r\n");
      out.write("  <tr class=\"table_header_center\">\r\n");
      ...
      out.write("  </tr>  \r\n");
      out.write("  <tr class=\"table_header_center\">  \t \r\n");
      out.write("  \t<td class='table_list_no_height' align='center'>Comments<br>(Max 4000char)</td>    \r\n");
