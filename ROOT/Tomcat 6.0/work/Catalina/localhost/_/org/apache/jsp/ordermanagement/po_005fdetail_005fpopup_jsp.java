...
public final class po_005fdetail_005fpopup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//out.println(sql);	      
 ...
 sql = "  select  a.id, a.name,a.phone1,a.fax, concat(a.addr1,' ',a.addr2) as addr , " +
          "  concat(a.surburb,' ',a.state,' ',b.code_name) as addr2 , a.contact  " +
  ...
  for (int i = 0; i < iRet; i++) {
    ...
    buyer_contact = matrix.getRowData(i).getData(6);
  }
  // get supplier code
   sql = "  select  a.id, a.name,a.phone1,a.fax, concat(a.addr1,' ',a.addr2) as addr , " +
