...
public final class buyer_005famend_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try {
 ...
 // Select PO details
  ...
  if (conn != null) {conn.close();}	
      ...
      out.write("\n");
      out.write("}\n");
      out.write(" function fnBack2(frm) {\n");
      out.write("  //frm.po_no_selected.value = jf_AllTrim(frm.po_no.value);\n");
      out.write("  frm.action = \"./buyer_order_amend_list.jsp\";\n");
      ...
      out.write("<tr>\n");
      out.write("\t<td width='100%' align='right'><font color=red><b>** 본 Purchase Order는 오더 확정 이후에 Amend(변경)가 되었습니다.** </b></td>\n");
 ...
 if ( Integer.parseInt(order_status) < 43 ) {
      ...
      out.write("<tr>\n");
      out.write("  <td width='100%' class='font_small_2'>**주)\n");
      out.write("    <ul>\n");
      out.write("      <li>Purchase Order가 Confirm되기 전까지는 정식 PO가 아니며 Pre-Purchase Order입니다.\n");
      out.write("      <li>본 Pre-Purchase Order는  Pro forma Purchase Order 단계임을 의미하며 정식 PO는 PO가 \n");
      out.write("      <li>확정되어 Confirm이된 이후에 정식 Purchase Order가 됩니다.</li>\n");
      out.write("    </ul>\n");
      out.write("  </td>\n");
      out.write("</tr>\n");
      out.write("</table>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<table width='840' border='0' bordercolor='black' cellspacing='0' cellpadding='0'>\n");
      out.write("<tr><td>\n");
      ...
      out.write("    <td width=\"19%\" height=\"22\" >하청공장</td>\n");
      ...
      out.write("  </tr>\n");
      out.write("  <tr class='table_header'>\n");
      out.write("    <td width=\"21%\" height=\"22\" >소재 </td>\n");
      out.write("    <td width=\"21%\" height=\"22\" >BRAND</td>\n");
      out.write("    <td width=\"23%\" height=\"22\" >배송형태</td>\n");
      out.write("    <td width=\"19%\" height=\"22\" >리오더차수</td>\n");
      out.write("    <td width=\"16%\" height=\"22\" ><font color=red>Amend(변경)일자</font></td>\n");
      out.write("  </tr>\n");
      out.write("  <tr class='table_list_center'>\n");
      out.write("    <td width=\"21%\" height=\"27\" >");
      out.print(mname);
      ...
      out.write("  </tr>  \n");
      out.write("</table>\n");
      out.write("<table width='840' border='1' cellspacing='1' cellpadding='2' align='center' bordercolor='black'>\n");
      out.write("  <tr class='table_header'>\n");
      ...
      out.write("    <input type='button' value='Back' onclick='fnBack2(this.form);'>\n");
      out.write("  </td>\n");
      out.write("</tr>\n");
      out.write("</FORM>\n");
      out.write("</table>\n");
