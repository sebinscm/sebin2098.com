...
public final class sample_005fsheet_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 // out.println(sql);
  ...
  if (conn != null) {
    conn.close();
      ...
      out.print( modified );
      out.write("</TD>\n");
      out.write("   <TD width='100' class='table_header_center'>Sent date</TD>\n");
      ...
      out.print( created );
      out.write("</TD>\n");
      out.write("   <TD width='200' class='table_header_center'>Updated D</TD>\n");
      out.write("  <TD width='100' class='table_bg_bright'>");
      out.print( modifier );
      out.write("</TD>\n");
      out.write("</TR>\n");
