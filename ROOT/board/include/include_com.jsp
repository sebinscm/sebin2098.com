...
{
  String str;
	str= "<CENTER><HR width=100% size=2 >";
	str = str + "<FONT size=2>&copy;Copyright 2005 ";
	str = str + "<FONT color=green>Valleygirl Fashions Pty Ltd.</FONT> All Rights Reserved.<BR>";
	str = str + "Contact to <FONT color=blue><A href='mailto:jeffreysong@valleygirl.com.au'>support@valleygirl.com.au</A></FONT>";
