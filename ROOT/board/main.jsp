...
<%!
private synchronized String get_board(String table, String image) {
...
String outS = "<table width=315 border=0 cellpadding=0 cellspacing=1>\n" +
	"<tr><td colspan=3><a href=\"board.jsp?table=" + table +
...
while( current > 0 && count < 7){
	...
	outS += "<a href=\"board.jsp?branch=V&mypage=1&table=" +
...
<%
String outAdminNotice= "";
String outNotice= "";
String outDepart= "";
String outForum= "";
String outKM= "";

outNotice = get_board("board_01t", "notice");
...
<TR height=190>
<TD valign=top><%=outAdminNotice%></TD>
<TD valign=top><%=outNotice%></TD>
</TR>
<TR>
<TD valign=top><%=outForum%></TD>
<TD valign=top><%=outKM%></TD>
</TR>
</TABLE>
</BODY>
</HTML>
